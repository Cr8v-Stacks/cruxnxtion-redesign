...
Handing this to another developer or AI agent? Read `CRUXNXTION_MASTER_REFERENCE.md` and `HANDOFF.md` first. `CRUXNXTION_MASTER_REFERENCE.md` documents all surgical fixes, WordPress theme/plugin packages, responsive rules, and build scripts.
