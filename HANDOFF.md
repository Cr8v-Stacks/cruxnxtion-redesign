...
- Founder facts. Provided by the owner's team on 2026-09-24 (confirmed): business strategist and dynamic serial entrepreneur; owns **Nxtion Food Market**, Sheffield (https://nxtionfoodmarket.com/); expanding into franchising and similar ventures (which business was not specified; copy says "franchising and related ventures"). Fact-check the owner's team supplied the same day (an AI research summary, sources not independently checked by me): "Oba of Events" is a real moniker he uses; Naija Food Carnival (July 2024, Network Sheffield) had roughly 400-460 guests, 20+ food vendors; the earlier "76+ events sold out" was NOT supported and was replaced with **"40+ events produced"** (his own public figure, "over 40 events in 5 years"). Please have him confirm the current event count before launch.
