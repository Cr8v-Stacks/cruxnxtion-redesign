...
// ---------------- FAQ (one long page, two sections) ----------------
{
  ...
  const EV=[
   ...
   ['How do I get started?','Send us a brief through the contact page, or email infoandsales@cruxnxtion.co.uk or call +44 7341 366400. Tell us the type of event, the date and roughly how many guests, and we will take it from there.'],
