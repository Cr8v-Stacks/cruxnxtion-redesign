...
// Complete event catalog matching site.json and prototype
$all_events = array(
...
if ( isset( $all_events[ $current_slug ] ) ) {
    ...
    $ev_data = array(
        ...
        'category' => 'Crux Event',
        'date_badge_day' => get_the_date('d'),
        'date_badge_month' => strtoupper( get_the_date('M') ),
        'date_str' => get_the_date('l, j F Y'),
        'time_str' => 'Evening — Late',
        'date_raw' => get_the_date('Y-m-d'),
        'location' => 'Sheffield',
        'country' => 'United Kingdom',
        'hero_image' => 'b094675514894aa0d8e7dd735d187b22',
        'desc_1' => get_the_excerpt() ? get_the_excerpt() : 'Get ready to groove and move like never before. An electrifying experience curated and produced by Crux Nxtion Events.',
        'desc_2' => 'Tickets and full details are on Eventbrite. Want a night like this for your own crowd? Our crew plans, books and runs it end to end.',
        'gallery' => array('c5afda4fc4e4d4b0682377d6eb272c90', '1d5292715423e2e83b56b3330a94b3b8', 'c5afda4fc4e4d4b0682377d6eb272c90'),
        'eventbrite' => 'https://www.eventbrite.co.uk/',
    );
    ...
    $ev_data = array(
        ...
        'date_badge_day' => '16',
        'date_badge_month' => 'DEC',
        'date_str' => 'Saturday, 16 December',
        'time_str' => '10:00 PM — Late',
        'date_raw' => '2025-12-16',
        'location' => 'Sheffield',
        'country' => 'United Kingdom',
        'hero_image' => 'b094675514894aa0d8e7dd735d187b22',
        'desc_1' => 'Get ready to groove and move like never before. An electrifying experience curated and produced by Crux Nxtion Events.',
        'desc_2' => 'Tickets and full details are on Eventbrite. Want a night like this for your own crowd? Our crew plans, books and runs it end to end.',
        'gallery' => array('c5afda4fc4e4d4b0682377d6eb272c90', '1d5292715423e2e83b56b3330a94b3b8', 'c5afda4fc4e4d4b0682377d6eb272c90'),
        'eventbrite' => 'https://www.eventbrite.co.uk/',
    );
...
<div style="width:100%; max-width:100%; margin:0; background:#0A0F26; overflow-x:clip;" data-m="root">
  ...
  <header style="position:sticky; top:0; z-index:1000; display:flex; align-items:center; justify-content:space-between; padding:0 20px; border-bottom:1px solid rgba(30,43,94,0.85); background:rgba(10,15,38,0.94); backdrop-filter:blur(14px); -webkit-backdrop-filter:blur(14px);">
    ...
    <nav style="display:flex; align-items:center; gap:28px;">
      ...
      <a href="<?php echo esc_url( home_url( "/events/" ) ); ?>" style="color:#5B8DEF; font-size:14px; font-weight:600; letter-spacing:0.2px; border-bottom:1.5px solid #5B8DEF;">Events</a>
  ...
  <section style="position:relative; margin:24px 20px 0px 20px; overflow:hidden; height:460px; clip-path:polygon(0 0,100% 0,100% 94%,0 100%); border:1.5px solid #1E2B5E;">
    <img src="<?php echo crux_get_blob_url( $ev_data['hero_image'] ); ?>" alt="<?php echo esc_attr( $ev_data['short_title'] ); ?>" style="position:absolute; inset:0; width:100%; height:100%; object-fit:cover;" class="drift">
  ...
  <section style="min-height:560px; padding:56px 20px 56px 20px; display:grid; grid-template-columns:1.6fr 1fr; gap:56px; align-items:start;" data-m="g1 nomin">
    <div class="reveal">
      ...
      <p style="font-size:15px; line-height:1.8; color:#B4BCDD; margin:0px 0px 20px 0px;"><?php echo esc_html( $ev_data['desc_1'] ); ?></p>
      <p style="font-size:15px; line-height:1.8; color:#B4BCDD; margin:0px 0px 32px 0px;"><?php echo esc_html( $ev_data['desc_2'] ); ?></p>
      ...
      <div style="display:grid; grid-template-columns:repeat(3, minmax(0, 1fr)); gap:14px;" data-m="g1">
        <?php foreach ( $ev_data['gallery'] as $img_id ) : ?>
        <img src="<?php echo crux_get_blob_url( $img_id ); ?>" alt="" style="width:100%; height:170px; object-fit:cover; border-radius:10px; border:1.5px solid #1E2B5E;" class="reveal">
        <?php endforeach; ?>
      </div>
    </div>
  ...
  <section style=" padding:20px 20px 44px 20px;">
    ...
    <div style="display:grid; grid-template-columns:repeat(2, minmax(0, 1fr)); gap:24px;" class="reveal" data-m="g1">
      ...
      <a href="<?php echo esc_url( home_url( "/event/" . $slug . "/" ) ); ?>" style="display:flex; flex-direction:column; background:#111838; border:1.5px solid #1E2B5E; border-radius:14px; overflow:hidden;" class="reveal">
        <div style="height:200px;"><img src="<?php echo crux_get_blob_url( $e_item['hero_image'] ); ?>" alt="<?php echo esc_attr( $e_item['short_title'] ); ?>" style="width:100%; height:100%; object-fit:cover; display:block;"></div>
