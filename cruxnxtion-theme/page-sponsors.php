...
<div style="width:100%; max-width:100%; margin:0; background:#0A0F26; overflow-x:clip;" data-m="root">
  ...
  <!-- SPONSORS HEADING -->
  <section style=" padding:44px 20px 40px 20px; display:grid; grid-template-columns:1.15fr .85fr; gap:56px; align-items:center;" data-m="g1">
    <div><span class="eyebrow">Sponsors &amp; Partners</span>
    <h1 class="bebas" style="font-size:44px; margin:14px 0px 16px 0px; color:#F4F5FA;">OUR SPONSORS<br><span style="color:#E5383B;">AND PARTNERSHIP.</span></h1>
    <h2 style="font-size:19px; line-height:1.4; font-weight:700; margin:0px 0px 14px 0px; color:#F4F5FA; max-width:560px;">Join the celebration: your gateway to extraordinary partnerships with Crux Nxtion Events.</h2>
    <p style="font-size:15.5px; line-height:1.7; color:#A3A9C8; max-width:560px; margin:0px 0px 26px 0px;">Welcome to the heart of collaboration. We are passionate about creating extraordinary experiences, and we believe in doing it together. Our partnership and vendors section is where connections spark, creativity thrives, and magic happens.</p>
    <div style="display:flex; gap:16px;"><a href="<?php echo esc_url( home_url( "/contact/?type=partner" ) ); ?>" style="background:#BA0000; color:#FFFFFF; font-weight:700; font-size:15px; padding:16px 30px 16px 30px; --sl:10px;" class="bx">Become A Partner</a><a href="<?php echo esc_url( home_url( "/events/" ) ); ?>" style="color:#F4F5FA; font-weight:700; font-size:15px; padding:14px 28px 14px 28px; --sl:10px; --bc:#5B8DEF;" class="bx">See Our Events</a></div></div>
    <div style="position:relative; height:440px; border-radius:16px; overflow:hidden; border:1.5px solid #1E2B5E;"><img src="<?php echo crux_get_blob_url( "2b696c907bf5b4d0dc14a80e8cd60e15" ); ?>" alt="Vendors serving guests at a Crux Nxtion event" style="width:100%; height:100%; object-fit:cover;"><div style="position:absolute; inset:0; background:linear-gradient(0deg,rgba(10,15,38,.7),rgba(10,15,38,0) 55%);"></div></div>
  </section>

  <!-- PARTNER WALL -->
  <section style=" padding:50px 20px 44px 20px;">
    <div style="display:flex; justify-content:space-between; align-items:flex-end; margin-bottom:30px;" data-m="stack"><div><span class="eyebrow">Vendors &amp; Partners</span><h2 class="bebas" style="font-size:34px; margin:12px 0px 0px 0px; color:#F4F5FA;">THE PEOPLE BEHIND THE NIGHT.</h2></div><p style="max-width:380px; font-size:14px; line-height:1.6; color:#A3A9C8; margin:0px 0px 0px 0px;">Caterers, photographers, DJs, beauty and jewellery brands who have joined our events.</p></div>
    <div style="display:grid; grid-template-columns:repeat(4, minmax(0, 1fr)); gap:26px 22px; align-items:start;" data-m="g2">
      <div style="display:flex; flex-direction:column; background:#111838; border:1.5px solid #1E2B5E; border-radius:12px; overflow:hidden; transform:rotate(-1deg);">
        <div style="position:relative; aspect-ratio:1/1; background:#F4F5FA;"><img src="<?php echo crux_get_blob_url( "3e237813fb9f6842a00a00f493717e50" ); ?>" alt="Crux Nxtion partner" style="width:100%; height:100%; object-fit:cover; display:block;"></div>
        <div class="strip-stub" style="background:#002671; padding:11px 16px 11px 16px; display:flex; justify-content:space-between; align-items:center;"><span style="font-size:11.5px; font-weight:800; color:#FFFFFF; letter-spacing:.8px; text-transform:uppercase;">Partner</span><span class="bebas" style="font-size:14px; color:#FFFFFF;">01</span></div>
      </div>
      <div style="display:flex; flex-direction:column; background:#111838; border:1.5px solid #1E2B5E; border-radius:12px; overflow:hidden; transform:rotate(0.8deg);">
        <div style="position:relative; aspect-ratio:1/1; background:#F4F5FA;"><img src="<?php echo crux_get_blob_url( "abbeaf5f563caf0a36336c5e0219cdc0" ); ?>" alt="Crux Nxtion partner" style="width:100%; height:100%; object-fit:cover; display:block;"></div>
        <div class="strip-stub" style="background:#BA0000; padding:11px 16px 11px 16px; display:flex; justify-content:space-between; align-items:center;"><span style="font-size:11.5px; font-weight:800; color:#FFFFFF; letter-spacing:.8px; text-transform:uppercase;">Partner</span><span class="bebas" style="font-size:14px; color:#FFFFFF;">02</span></div>
      </div>
      <div style="display:flex; flex-direction:column; background:#111838; border:1.5px solid #1E2B5E; border-radius:12px; overflow:hidden; transform:rotate(-0.6deg);">
        <div style="position:relative; aspect-ratio:1/1; background:#F4F5FA;"><img src="<?php echo crux_get_blob_url( "de1eac2cea70d9ffc75148b9accd0833" ); ?>" alt="ML" style="width:100%; height:100%; object-fit:cover; display:block;"></div>
        <div class="strip-stub" style="background:#8C7AE6; padding:11px 16px 11px 16px; display:flex; justify-content:space-between; align-items:center;"><span style="font-size:11.5px; font-weight:800; color:#10142E; letter-spacing:.8px; text-transform:uppercase;">ML</span><span class="bebas" style="font-size:14px; color:#10142E;">03</span></div>
      </div>
      <div style="display:flex; flex-direction:column; background:#111838; border:1.5px solid #1E2B5E; border-radius:12px; overflow:hidden; transform:rotate(1deg);">
        <div style="position:relative; aspect-ratio:1/1; background:#F4F5FA;"><img src="<?php echo crux_get_blob_url( "0dabf904386bf3c567390a985651785e" ); ?>" alt="Phemzy Studios" style="width:100%; height:100%; object-fit:cover; display:block;"></div>
        <div class="strip-stub" style="background:#002671; padding:11px 16px 11px 16px; display:flex; justify-content:space-between; align-items:center;"><span style="font-size:11.5px; font-weight:800; color:#FFFFFF; letter-spacing:.8px; text-transform:uppercase;">Phemzy Studios</span><span class="bebas" style="font-size:14px; color:#FFFFFF;">04</span></div>
      </div>
      <div style="display:flex; flex-direction:column; background:#111838; border:1.5px solid #1E2B5E; border-radius:12px; overflow:hidden; transform:rotate(-1deg);">
        <div style="position:relative; aspect-ratio:1/1; background:#F4F5FA;"><img src="<?php echo crux_get_blob_url( "31c531a4db0e51855507e872d273fc64" ); ?>" alt="Crux Nxtion partner" style="width:100%; height:100%; object-fit:cover; display:block;"></div>
        <div class="strip-stub" style="background:#BA0000; padding:11px 16px 11px 16px; display:flex; justify-content:space-between; align-items:center;"><span style="font-size:11.5px; font-weight:800; color:#FFFFFF; letter-spacing:.8px; text-transform:uppercase;">Partner</span><span class="bebas" style="font-size:14px; color:#FFFFFF;">05</span></div>
      </div>
      <div style="display:flex; flex-direction:column; background:#111838; border:1.5px solid #1E2B5E; border-radius:12px; overflow:hidden; transform:rotate(0.8deg);">
        <div style="position:relative; aspect-ratio:1/1; background:#F4F5FA;"><img src="<?php echo crux_get_blob_url( "0e3450f2f8f0a4ce5afd084843a3cb2f" ); ?>" alt="Dotun Omiyale" style="width:100%; height:100%; object-fit:cover; display:block;"></div>
        <div class="strip-stub" style="background:#8C7AE6; padding:11px 16px 11px 16px; display:flex; justify-content:space-between; align-items:center;"><span style="font-size:11.5px; font-weight:800; color:#10142E; letter-spacing:.8px; text-transform:uppercase;">Dotun Omiyale</span><span class="bebas" style="font-size:14px; color:#10142E;">06</span></div>
      </div>
      <div style="display:flex; flex-direction:column; background:#111838; border:1.5px solid #1E2B5E; border-radius:12px; overflow:hidden; transform:rotate(-0.6deg);">
        <div style="position:relative; aspect-ratio:1/1; background:#F4F5FA;"><img src="<?php echo crux_get_blob_url( "e2d1c89ac716ea5f92ab8e31be53bade" ); ?>" alt="Crux Nxtion partner" style="width:100%; height:100%; object-fit:cover; display:block;"></div>
        <div class="strip-stub" style="background:#002671; padding:11px 16px 11px 16px; display:flex; justify-content:space-between; align-items:center;"><span style="font-size:11.5px; font-weight:800; color:#FFFFFF; letter-spacing:.8px; text-transform:uppercase;">Partner</span><span class="bebas" style="font-size:14px; color:#FFFFFF;">07</span></div>
      </div>
      <div style="display:flex; flex-direction:column; background:#111838; border:1.5px solid #1E2B5E; border-radius:12px; overflow:hidden; transform:rotate(1deg);">
        <div style="position:relative; aspect-ratio:1/1; background:#F4F5FA;"><img src="<?php echo crux_get_blob_url( "15e555b5257378f29e72ecde1fb7e5f3" ); ?>" alt="DJ03" style="width:100%; height:100%; object-fit:cover; display:block;"></div>
        <div class="strip-stub" style="background:#BA0000; padding:11px 16px 11px 16px; display:flex; justify-content:space-between; align-items:center;"><span style="font-size:11.5px; font-weight:800; color:#FFFFFF; letter-spacing:.8px; text-transform:uppercase;">DJ03</span><span class="bebas" style="font-size:14px; color:#FFFFFF;">08</span></div>
      </div>
      <div style="display:flex; flex-direction:column; background:#111838; border:1.5px solid #1E2B5E; border-radius:12px; overflow:hidden; transform:rotate(-1deg);">
        <div style="position:relative; aspect-ratio:1/1; background:#F4F5FA;"><img src="<?php echo crux_get_blob_url( "85b05c3630e70a76a40b1411919f2987" ); ?>" alt="Crux Nxtion partner" style="width:100%; height:100%; object-fit:cover; display:block;"></div>
        <div class="strip-stub" style="background:#8C7AE6; padding:11px 16px 11px 16px; display:flex; justify-content:space-between; align-items:center;"><span style="font-size:11.5px; font-weight:800; color:#10142E; letter-spacing:.8px; text-transform:uppercase;">Partner</span><span class="bebas" style="font-size:14px; color:#10142E;">09</span></div>
      </div>
      <div style="display:flex; flex-direction:column; background:#111838; border:1.5px solid #1E2B5E; border-radius:12px; overflow:hidden; transform:rotate(0.8deg);">
        <div style="position:relative; aspect-ratio:1/1; background:#F4F5FA;"><img src="<?php echo crux_get_blob_url( "0f86db33ccd6204138c27980499a58e1" ); ?>" alt="D20 Pasties" style="width:100%; height:100%; object-fit:cover; display:block;"></div>
        <div class="strip-stub" style="background:#002671; padding:11px 16px 11px 16px; display:flex; justify-content:space-between; align-items:center;"><span style="font-size:11.5px; font-weight:800; color:#FFFFFF; letter-spacing:.8px; text-transform:uppercase;">D20 Pasties</span><span class="bebas" style="font-size:14px; color:#FFFFFF;">10</span></div>
      </div>
      <div style="display:flex; flex-direction:column; background:#111838; border:1.5px solid #1E2B5E; border-radius:12px; overflow:hidden; transform:rotate(-0.6deg);">
        <div style="position:relative; aspect-ratio:1/1; background:#F4F5FA;"><img src="<?php echo crux_get_blob_url( "2d13a2f72d6824fb6334d5366984c9df" ); ?>" alt="Livingbangel Beauty Lounge" style="width:100%; height:100%; object-fit:cover; display:block;"></div>
        <div class="strip-stub" style="background:#BA0000; padding:11px 16px 11px 16px; display:flex; justify-content:space-between; align-items:center;"><span style="font-size:11.5px; font-weight:800; color:#FFFFFF; letter-spacing:.8px; text-transform:uppercase;">Livingbangel Beauty Lounge</span><span class="bebas" style="font-size:14px; color:#FFFFFF;">11</span></div>
      </div>
      <div style="display:flex; flex-direction:column; background:#111838; border:1.5px solid #1E2B5E; border-radius:12px; overflow:hidden; transform:rotate(1deg);">
        <div style="position:relative; aspect-ratio:1/1; background:#F4F5FA;"><img src="<?php echo crux_get_blob_url( "18373137dc739154d5a9c88a4f075201" ); ?>" alt="Food Emporium UK" style="width:100%; height:100%; object-fit:cover; display:block;"></div>
        <div class="strip-stub" style="background:#8C7AE6; padding:11px 16px 11px 16px; display:flex; justify-content:space-between; align-items:center;"><span style="font-size:11.5px; font-weight:800; color:#10142E; letter-spacing:.8px; text-transform:uppercase;">Food Emporium UK</span><span class="bebas" style="font-size:14px; color:#10142E;">12</span></div>
      </div>
      <div style="display:flex; flex-direction:column; background:#111838; border:1.5px solid #1E2B5E; border-radius:12px; overflow:hidden; transform:rotate(-1deg);">
        <div style="position:relative; aspect-ratio:1/1; background:#F4F5FA;"><img src="<?php echo crux_get_blob_url( "1a6f99c10b46fe8f6da34271f5eaf048" ); ?>" alt="Crux Nxtion partner" style="width:100%; height:100%; object-fit:cover; display:block;"></div>
        <div class="strip-stub" style="background:#002671; padding:11px 16px 11px 16px; display:flex; justify-content:space-between; align-items:center;"><span style="font-size:11.5px; font-weight:800; color:#FFFFFF; letter-spacing:.8px; text-transform:uppercase;">Partner</span><span class="bebas" style="font-size:14px; color:#FFFFFF;">13</span></div>
      </div>
      <div style="display:flex; flex-direction:column; background:#111838; border:1.5px solid #1E2B5E; border-radius:12px; overflow:hidden; transform:rotate(0.8deg);">
        <div style="position:relative; aspect-ratio:1/1; background:#F4F5FA;"><img src="<?php echo crux_get_blob_url( "5d9392be79f6ba3f1fb18b1923e80c13" ); ?>" alt="Crux Nxtion partner" style="width:100%; height:100%; object-fit:cover; display:block;"></div>
        <div class="strip-stub" style="background:#BA0000; padding:11px 16px 11px 16px; display:flex; justify-content:space-between; align-items:center;"><span style="font-size:11.5px; font-weight:800; color:#FFFFFF; letter-spacing:.8px; text-transform:uppercase;">Partner</span><span class="bebas" style="font-size:14px; color:#FFFFFF;">14</span></div>
      </div>
      <div style="display:flex; flex-direction:column; background:#111838; border:1.5px solid #1E2B5E; border-radius:12px; overflow:hidden; transform:rotate(-0.6deg);">
        <div style="position:relative; aspect-ratio:1/1; background:#F4F5FA;"><img src="<?php echo crux_get_blob_url( "4ae9886f77ee1545ce79727e031a2c76" ); ?>" alt="Sokid Photography" style="width:100%; height:100%; object-fit:cover; display:block;"></div>
        <div class="strip-stub" style="background:#8C7AE6; padding:11px 16px 11px 16px; display:flex; justify-content:space-between; align-items:center;"><span style="font-size:11.5px; font-weight:800; color:#10142E; letter-spacing:.8px; text-transform:uppercase;">Sokid Photography</span><span class="bebas" style="font-size:14px; color:#10142E;">15</span></div>
      </div>
      <div style="display:flex; flex-direction:column; background:#111838; border:1.5px solid #1E2B5E; border-radius:12px; overflow:hidden; transform:rotate(1deg);">
        <div style="position:relative; aspect-ratio:1/1; background:#F4F5FA;"><img src="<?php echo crux_get_blob_url( "c205c0a2e87784d728fe729edd731e2e" ); ?>" alt="Zee Jewels" style="width:100%; height:100%; object-fit:cover; display:block;"></div>
        <div class="strip-stub" style="background:#002671; padding:11px 16px 11px 16px; display:flex; justify-content:space-between; align-items:center;"><span style="font-size:11.5px; font-weight:800; color:#FFFFFF; letter-spacing:.8px; text-transform:uppercase;">Zee Jewels</span><span class="bebas" style="font-size:14px; color:#FFFFFF;">16</span></div>
      </div>
      <div style="display:flex; flex-direction:column; background:#111838; border:1.5px solid #1E2B5E; border-radius:12px; overflow:hidden; transform:rotate(-1deg);">
        <div style="position:relative; aspect-ratio:1/1; background:#F4F5FA;"><img src="<?php echo crux_get_blob_url( "fc86f6756c4525131aadac80ca442a7b" ); ?>" alt="Rosella's Wonder" style="width:100%; height:100%; object-fit:cover; display:block;"></div>
        <div class="strip-stub" style="background:#BA0000; padding:11px 16px 11px 16px; display:flex; justify-content:space-between; align-items:center;"><span style="font-size:11.5px; font-weight:800; color:#FFFFFF; letter-spacing:.8px; text-transform:uppercase;">Rosella's Wonder</span><span class="bebas" style="font-size:14px; color:#FFFFFF;">17</span></div>
      </div>
    </div>
  </section>
