...
<div style="width:100%; max-width:100%; margin:0; background:#0A0F26; overflow-x:clip;" data-m="root">
  ...
  <section style=" padding:20px 20px 44px 20px;">
    <div style="display:grid; grid-template-columns:140px 1fr; gap:40px; padding:34px 0px 34px 0px; border-top:1.5px solid #1E2B5E;" data-m="g1">
      <div class="bebas" style="font-size:40px; color:#5B8DEF; line-height:1;">2025</div>
    ...
    <div style="display:grid; grid-template-columns:140px 1fr; gap:40px; padding:34px 0px 34px 0px; border-top:1.5px solid #1E2B5E;" data-m="g1">
      <div class="bebas" style="font-size:40px; color:#5B8DEF; line-height:1;">2024</div>
      <div style="display:flex; flex-direction:column; gap:16px;">
    ...
    <div style="display:grid; grid-template-columns:140px 1fr; gap:40px; padding:34px 0px 34px 0px; border-top:1.5px solid #1E2B5E;" data-m="g1">
      <div class="bebas" style="font-size:40px; color:#5B8DEF; line-height:1;">2023</div>
      <div style="display:flex; flex-direction:column; gap:16px;">
    ...
    <div style="display:grid; grid-template-columns:140px 1fr; gap:40px; padding:34px 0px 34px 0px; border-top:1.5px solid #1E2B5E;" data-m="g1">
      <div class="bebas" style="font-size:40px; color:#5B8DEF; line-height:1;">2022</div>
      <div style="display:flex; flex-direction:column; gap:16px;">
    ...
    <div style="display:grid; grid-template-columns:140px 1fr; gap:40px; padding:34px 0px 34px 0px; border-top:1.5px solid #1E2B5E;" data-m="g1">
      <div class="bebas" style="font-size:40px; color:#5B8DEF; line-height:1;">2021</div>
      <div style="display:flex; flex-direction:column; gap:16px;">
