...
<div style="width:100%; max-width:100%; margin:0; background:#0A0F26; overflow-x:clip;" data-m="root">
  ...
  <header style="position:sticky; top:0; z-index:1000; display:flex; align-items:center; justify-content:space-between; min-height:80px; padding:14px 20px; border-bottom:1px solid rgba(30,43,94,0.85); background:rgba(10,15,38,0.94); backdrop-filter:blur(14px); -webkit-backdrop-filter:blur(14px);">
    ...
    <nav style="display:flex; align-items:center; gap:28px;">
      ...
      <a href="<?php echo esc_url( home_url( "/gallery/" ) ); ?>" style="color:#5B8DEF; font-size:14px; font-weight:600; letter-spacing:0.2px; border-bottom:1.5px solid #5B8DEF;">Gallery</a>
  ...
  <section style=" padding:44px 20px 20px 20px;">
    ...
    <h1 class="bebas" style="font-size:44px; margin:14px 0px 14px 0px; color:#F4F5FA;">GALLERY</h1>
    <p style="font-size:15px; color:#A3A9C8; max-width:520px; margin:0px 0px 0px 0px;" class="reveal">Every frame, filed like a ticket — punched by the same crew.</p>
  </section>
  ...
  <section style=" padding:30px 20px 44px 20px;">
    <div style="display:grid; grid-template-columns:repeat(3, minmax(0, 1fr)); gap:34px 26px; align-items:start;" class="reveal" data-m="g2">
      ...
      <a href="#" style="display:flex; flex-direction:column; background:#111838; border:1.5px solid #1E2B5E; border-radius:12px; overflow:hidden; transform:rotate(0.6deg);" class="reveal">
        ...
        <div class="strip-stub" style="background:#002671; padding:12px 18px 12px 18px; display:flex; justify-content:space-between; align-items:center;"><span style="font-size:12px; font-weight:800; color:#FFFFFF;">CULTURE</span><span class="bebas" style="font-size:14px; color:#FFFFFF;">FRAME 04</span></div>
      </a>
      <a href="#" style="display:flex; flex-direction:column; background:#111838; border:1.5px solid #1E2B5E; border-radius:12px; overflow:hidden; transform:rotate(-0.6deg);" class="reveal">
        ...
        <div class="strip-stub" style="background:#BA0000; padding:12px 18px 12px 18px; display:flex; justify-content:space-between; align-items:center;"><span style="font-size:12px; font-weight:800; color:#FFFFFF;">CREW</span><span class="bebas" style="font-size:14px; color:#FFFFFF;">FRAME 05</span></div>
      </a>
      <a href="#" style="display:flex; flex-direction:column; background:#111838; border:1.5px solid #1E2B5E; border-radius:12px; overflow:hidden; transform:rotate(1deg);" class="reveal">
        ...
        <div class="strip-stub" style="background:#8C7AE6; padding:12px 18px 12px 18px; display:flex; justify-content:space-between; align-items:center;"><span style="font-size:12px; font-weight:800; color:#0A0F26;">PRIVATE</span><span class="bebas" style="font-size:14px; color:#0A0F26;">FRAME 06</span></div>
      </a>
      <a href="#" style="display:flex; flex-direction:column; background:#111838; border:1.5px solid #1E2B5E; border-radius:12px; overflow:hidden; transform:rotate(-1deg);" class="reveal">
        ...
        <div class="strip-stub" style="background:#002671; padding:12px 18px 12px 18px; display:flex; justify-content:space-between; align-items:center;"><span style="font-size:12px; font-weight:800; color:#FFFFFF;">WEDDING</span><span class="bebas" style="font-size:14px; color:#FFFFFF;">FRAME 07</span></div>
      </a>
      <a href="#" style="display:flex; flex-direction:column; background:#111838; border:1.5px solid #1E2B5E; border-radius:12px; overflow:hidden; transform:rotate(0.8deg);" class="reveal">
        ...
        <div class="strip-stub" style="background:#BA0000; padding:12px 18px 12px 18px; display:flex; justify-content:space-between; align-items:center;"><span style="font-size:12px; font-weight:800; color:#FFFFFF;">NIGHT OUT</span><span class="bebas" style="font-size:14px; color:#FFFFFF;">FRAME 08</span></div>
      </a>
      <a href="#" style="display:flex; flex-direction:column; background:#111838; border:1.5px solid #1E2B5E; border-radius:12px; overflow:hidden; transform:rotate(-0.8deg);" class="reveal">
        ...
        <div class="strip-stub" style="background:#8C7AE6; padding:12px 18px 12px 18px; display:flex; justify-content:space-between; align-items:center;"><span style="font-size:12px; font-weight:800; color:#0A0F26;">LIVE</span><span class="bebas" style="font-size:14px; color:#0A0F26;">FRAME 09</span></div>
      </a>
      <a href="#" style="display:flex; flex-direction:column; background:#111838; border:1.5px solid #1E2B5E; border-radius:12px; overflow:hidden; transform:rotate(0.6deg);">
        ...
        <div class="strip-stub" style="background:#002671; padding:12px 18px 12px 18px; display:flex; justify-content:space-between; align-items:center;"><span style="font-size:12px; font-weight:800; color:#FFFFFF;">CULTURE</span><span class="bebas" style="font-size:14px; color:#FFFFFF;">FRAME 10</span></div>
      </a>
      <a href="#" style="display:flex; flex-direction:column; background:#111838; border:1.5px solid #1E2B5E; border-radius:12px; overflow:hidden; transform:rotate(-0.6deg);">
        ...
        <div class="strip-stub" style="background:#BA0000; padding:12px 18px 12px 18px; display:flex; justify-content:space-between; align-items:center;"><span style="font-size:12px; font-weight:800; color:#FFFFFF;">CREW</span><span class="bebas" style="font-size:14px; color:#FFFFFF;">FRAME 11</span></div>
      </a>
      <a href="#" style="display:flex; flex-direction:column; background:#111838; border:1.5px solid #1E2B5E; border-radius:12px; overflow:hidden; transform:rotate(1deg);">
        ...
        <div class="strip-stub" style="background:#8C7AE6; padding:12px 18px 12px 18px; display:flex; justify-content:space-between; align-items:center;"><span style="font-size:12px; font-weight:800; color:#0A0F26;">PRIVATE</span><span class="bebas" style="font-size:14px; color:#0A0F26;">FRAME 12</span></div>
      </a>
      <a href="#" style="display:flex; flex-direction:column; background:#111838; border:1.5px solid #1E2B5E; border-radius:12px; overflow:hidden; transform:rotate(-1deg);">
        ...
        <div class="strip-stub" style="background:#002671; padding:12px 18px 12px 18px; display:flex; justify-content:space-between; align-items:center;"><span style="font-size:12px; font-weight:800; color:#FFFFFF;">WEDDING</span><span class="bebas" style="font-size:14px; color:#FFFFFF;">FRAME 13</span></div>
      </a>
      <a href="#" style="display:flex; flex-direction:column; background:#111838; border:1.5px solid #1E2B5E; border-radius:12px; overflow:hidden; transform:rotate(0.8deg);">
        ...
        <div class="strip-stub" style="background:#BA0000; padding:12px 18px 12px 18px; display:flex; justify-content:space-between; align-items:center;"><span style="font-size:12px; font-weight:800; color:#FFFFFF;">NIGHT OUT</span><span class="bebas" style="font-size:14px; color:#FFFFFF;">FRAME 14</span></div>
      </a>
      <a href="#" style="display:flex; flex-direction:column; background:#111838; border:1.5px solid #1E2B5E; border-radius:12px; overflow:hidden; transform:rotate(-0.8deg);">
        ...
        <div class="strip-stub" style="background:#8C7AE6; padding:12px 18px 12px 18px; display:flex; justify-content:space-between; align-items:center;"><span style="font-size:12px; font-weight:800; color:#0A0F26;">LIVE</span><span class="bebas" style="font-size:14px; color:#0A0F26;">FRAME 15</span></div>
      </a>
    </div>
  </section>
