...
<div style="width:100%; max-width:100%; margin:0; background:#FFFFFF; overflow-x:clip;" data-m="root">
  ...
  <header style="position:sticky; top:0; z-index:1000; display:flex; align-items:center; justify-content:space-between; min-height:80px; padding:14px 20px; border-bottom:1px solid rgba(225,222,243,0.85); background:rgba(255,255,255,0.95); backdrop-filter:blur(14px); -webkit-backdrop-filter:blur(14px);">
    ...
    <nav style="display:flex; align-items:center; gap:28px;">
      ...
      <a href="<?php echo esc_url( home_url( "/about/" ) ); ?>" style="color:#6C58DB; font-size:14px; font-weight:600; letter-spacing:0.2px; border-bottom:1.5px solid #6C58DB;">About</a>
  ...
  <section style="min-height:800px; display:grid; grid-template-columns:1fr 1fr; gap:60px; align-items:center; padding:44px 20px 44px 20px;" data-m="g1 nomin">
    <div class="reveal">
      ...
      <h1 class="bebas" style="font-size:40px; line-height:0.98; white-space:nowrap; margin:18px 0px 22px 0px; color:#10142E;">ONE CREW.<br>TWO WAYS TO BUILD<br><span style="color:#6C58DB;">SOMETHING THAT LASTS.</span></h1>
      <p style="font-size:17px; line-height:1.7; color:#3A3F66; max-width:540px; margin:0px 0px 30px 0px;">We plan, book and run events people talk about for weeks — and we help the businesses behind them get clearer, bolder and better organised. Two services, one Sheffield crew.</p>
      <div style="display:flex; gap:16px;"><a href="<?php echo esc_url( home_url( "/founder/" ) ); ?>" style="background:#8C7AE6; color:#10142E; font-weight:700; font-size:15px; padding:16px 30px 16px 30px; --sl:10px;" class="bx">Meet The Founder</a><a href="<?php echo esc_url( home_url( "/contact/" ) ); ?>" style="color:#10142E; font-weight:700; font-size:15px; padding:14.5px 28px 14.5px 28px; --sl:10px; --bc:#10142E;" class="bx">Get In Touch</a></div>
    </div>
    <div style="position:relative; height:640px;" class="reveal why-us-collage" data-m="tile collage">
      ...
      <div class="float" style="--r:6deg; position:absolute; right:-6px; bottom:60px; background:#FF2E3D; color:#FFFFFF; padding:12px 18px 12px 18px; border-radius:10px;"><span class="bebas" style="font-size:20px;">SHEFFIELD, UK</span></div>
    </div>
  </section>
  ...
  <section style="min-height:760px; padding:44px 20px 44px 20px; background:#F3F1FC; display:grid; grid-template-columns:0.9fr 1.1fr; gap:80px; align-items:center;" data-m="g1 nomin">
    <h2 class="bebas reveal" style="font-size:40px; margin:0px 0px 0px 0px; color:#10142E;">WE STARTED WITH PARTIES. WE STAYED FOR THE <span style="color:#6C58DB;">PLAN BEHIND THEM.</span></h2>
    <div class="reveal">
      <p style="font-size:16px; line-height:1.85; color:#3A3F66; margin:0px 0px 18px 0px;">Crux Nxtion Events is your gateway to extraordinary event experiences in the UK. We merge creativity with precision, turning ordinary moments into unforgettable memories — whether it's a corporate function, a wedding celebration or a music festival.</p>
      <p style="font-size:16px; line-height:1.85; color:#3A3F66; margin:0px 0px 28px 0px;">As our clients grew, they kept asking for the thinking behind the event: the brand, the growth plan, the next move. That's how Crux Nxtion Consultancy began — the same care and attention to detail, pointed at your business.</p>
      <div style="display:flex; gap:12px; flex-wrap:wrap;" data-m="wrap"><span style="background:#FFFFFF; color:#3A3F66; font-size:12.5px; font-weight:600; padding:10px 18px 10px 18px; --sl:6px; --bc:#D2CEEA;" class="bx">Sheffield, UK</span><span style="background:#FFFFFF; color:#3A3F66; font-size:12.5px; font-weight:600; padding:10px 18px 10px 18px; --sl:6px; --bc:#D2CEEA;" class="bx">One-stop solution</span><span style="background:#FFFFFF; color:#3A3F66; font-size:12.5px; font-weight:600; padding:10px 18px 10px 18px; --sl:6px; --bc:#D2CEEA;" class="bx">Client-centric</span><span style="background:#FFFFFF; color:#3A3F66; font-size:12.5px; font-weight:600; padding:10px 18px 10px 18px; --sl:6px; --bc:#D2CEEA;" class="bx">Creativity with precision</span></div>
    </div>
  </section>
  ...
  <section style="min-height:820px; padding:44px 20px 44px 20px;" data-m="nomin">
    <div style="display:flex; justify-content:space-between; align-items:flex-end; margin-bottom:40px;" class="reveal" data-m="stack">
      <div><span class="eyebrow">What We Do</span><h2 class="bebas" style="font-size:40px; margin:12px 0px 0px 0px; color:#10142E;">TWO SERVICES. ONE CREW.</h2></div>
      <div style="display:inline-flex; gap:4px; gap:6px;"><button onclick="{{pickEvents}}" style="{{eventsTabStyle}:{{eventsTabStyle}}; --sl:8px; --bc:#88888855;" class="bx">Events</button><button onclick="{{pickConsult}}" style="{{consultTabStyle}:{{consultTabStyle}}; --sl:8px; --bc:#88888855;" class="bx">Consultancy</button></div>
    </div>
    <sc-if value="{{isEvents}}" hint-placeholder-val="{{true}}"><div style="display:grid; grid-template-columns:repeat(6, minmax(0, 1fr)); grid-template-rows:repeat(2, 320px); gap:16px;" data-m="g1">
      <a href="#" class="bento-tile reveal" style="grid-column:span 3; position:relative; overflow:hidden; border-radius:22px; display:block;" data-m="span tile">
        ...
        <div style="position:absolute; left:0; right:0; bottom:0; padding:26px 26px 26px 26px;"><h3 class="bebas" style="font-size:30px; margin:0px 0px 6px 0px; color:#F2F1F8;">EVENT MANAGEMENT &amp; PLANNING</h3><p style="font-size:13px; line-height:1.6; color:#C7C7DA; margin:0px 0px 0px 0px;">Meticulous coordination and planning for private and corporate events.</p></div>
      </a>
      <a href="#" class="bento-tile reveal" style="grid-column:span 3; position:relative; overflow:hidden; border-radius:22px; display:block;" data-m="span tile">
        ...
        <div style="position:absolute; inset:0; background:linear-gradient(0deg, rgba(16,20,46,0.95) 0%, rgba(16,20,46,0.35) 65%, rgba(16,20,46,0.15) 100%);"></div>
        <div style="position:absolute; left:0; right:0; bottom:0; padding:26px 26px 26px 26px;"><h3 class="bebas" style="font-size:30px; margin:0px 0px 6px 0px; color:#F2F1F8;">ENTERTAINMENT BOOKING &amp; TALENT</h3><p style="font-size:13px; line-height:1.6; color:#C7C7DA; margin:0px 0px 0px 0px;">Star power and top-tier talent, matched to the vibe of your event.</p></div>
      </a>
      <a href="#" class="bento-tile reveal" style="grid-column:span 2; position:relative; overflow:hidden; border-radius:22px; display:block;" data-m="span tile">
        ...
        <div style="position:absolute; inset:0; background:linear-gradient(0deg, rgba(16,20,46,0.95) 0%, rgba(16,20,46,0.35) 65%, rgba(16,20,46,0.15) 100%);"></div>
        <div style="position:absolute; left:0; right:0; bottom:0; padding:26px 26px 26px 26px;"><h3 class="bebas" style="font-size:30px; margin:0px 0px 6px 0px; color:#F2F1F8;">EVENT DESIGNS &amp; PRODUCTION</h3><p style="font-size:13px; line-height:1.6; color:#C7C7DA; margin:0px 0px 0px 0px;">Themed, creative production for weddings, birthdays and launches.</p></div>
      </a>
      <a href="#" class="bento-tile reveal" style="grid-column:span 2; position:relative; overflow:hidden; border-radius:22px; display:block;" data-m="span tile">
        ...
        <div style="position:absolute; inset:0; background:linear-gradient(0deg, rgba(16,20,46,0.95) 0%, rgba(16,20,46,0.35) 65%, rgba(16,20,46,0.15) 100%);"></div>
        <div style="position:absolute; left:0; right:0; bottom:0; padding:26px 26px 26px 26px;"><h3 class="bebas" style="font-size:30px; margin:0px 0px 6px 0px; color:#F2F1F8;">EVENT MARKETING &amp; PROMOTION</h3><p style="font-size:13px; line-height:1.6; color:#C7C7DA; margin:0px 0px 0px 0px;">Buzz, visibility and promotion that fills the room.</p></div>
      </a>
      <a href="#" class="bento-tile reveal" style="grid-column:span 2; position:relative; overflow:hidden; border-radius:22px; display:block;" data-m="span tile">
        ...
        <div style="position:absolute; inset:0; background:linear-gradient(0deg, rgba(16,20,46,0.95) 0%, rgba(16,20,46,0.35) 65%, rgba(16,20,46,0.15) 100%);"></div>
        <div style="position:absolute; left:0; right:0; bottom:0; padding:26px 26px 26px 26px;"><h3 class="bebas" style="font-size:30px; margin:0px 0px 6px 0px; color:#F2F1F8;">ON-SITE COORDINATION</h3><p style="font-size:13px; line-height:1.6; color:#C7C7DA; margin:0px 0px 0px 0px;">Real-time support, venue logistics and day-of management.</p></div>
      </a></div></sc-if>
    <sc-if value="{{isConsult}}" hint-placeholder-val="{{false}}"><div style="display:grid; grid-template-columns:repeat(6, minmax(0, 1fr)); grid-template-rows:repeat(2, 320px); gap:16px;" data-m="g1">
      <a href="#" class="bento-tile" style="grid-column:span 3; position:relative; overflow:hidden; border-radius:22px; display:block;" data-m="span tile">
        ...
        <div style="position:absolute; inset:0; background:linear-gradient(0deg, rgba(16,20,46,0.95) 0%, rgba(16,20,46,0.35) 65%, rgba(16,20,46,0.15) 100%);"></div>
        <div style="position:absolute; left:0; right:0; bottom:0; padding:26px 26px 26px 26px;"><h3 class="bebas" style="font-size:30px; margin:0px 0px 6px 0px; color:#F2F1F8;">BUSINESS SETUP &amp; STRATEGY</h3><p style="font-size:13px; line-height:1.6; color:#C7C7DA; margin:0px 0px 0px 0px;">Structure, positioning and a clear plan for the business you want to build.</p></div>
      </a>
      <a href="#" class="bento-tile" style="grid-column:span 3; position:relative; overflow:hidden; border-radius:22px; display:block;" data-m="span tile">
        ...
        <div style="position:absolute; inset:0; background:linear-gradient(0deg, rgba(16,20,46,0.95) 0%, rgba(16,20,46,0.35) 65%, rgba(16,20,46,0.15) 100%);"></div>
        <div style="position:absolute; left:0; right:0; bottom:0; padding:26px 26px 26px 26px;"><h3 class="bebas" style="font-size:30px; margin:0px 0px 6px 0px; color:#F2F1F8;">BRANDING &amp; MARKETING</h3><p style="font-size:13px; line-height:1.6; color:#C7C7DA; margin:0px 0px 0px 0px;">An identity and a marketing plan that say what you do.</p></div>
      </a>
      <a href="#" class="bento-tile" style="grid-column:span 2; position:relative; overflow:hidden; border-radius:22px; display:block;" data-m="span tile">
        ...
        <div style="position:absolute; inset:0; background:linear-gradient(0deg, rgba(16,20,46,0.95) 0%, rgba(16,20,46,0.35) 65%, rgba(16,20,46,0.15) 100%);"></div>
        <div style="position:absolute; left:0; right:0; bottom:0; padding:26px 26px 26px 26px;"><h3 class="bebas" style="font-size:30px; margin:0px 0px 6px 0px; color:#F2F1F8;">BUSINESS GROWTH</h3><p style="font-size:13px; line-height:1.6; color:#C7C7DA; margin:0px 0px 0px 0px;">A realistic route to more customers and more revenue.</p></div>
      </a>
      <a href="#" class="bento-tile" style="grid-column:span 2; position:relative; overflow:hidden; border-radius:22px; display:block;" data-m="span tile">
        ...
        <div style="position:absolute; inset:0; background:linear-gradient(0deg, rgba(16,20,46,0.95) 0%, rgba(16,20,46,0.35) 65%, rgba(16,20,46,0.15) 100%);"></div>
        <div style="position:absolute; left:0; right:0; bottom:0; padding:26px 26px 26px 26px;"><h3 class="bebas" style="font-size:30px; margin:0px 0px 6px 0px; color:#F2F1F8;">ACTIVATION GROWTH</h3><p style="font-size:13px; line-height:1.6; color:#C7C7DA; margin:0px 0px 0px 0px;">Campaigns and activations that turn attention into action.</p></div>
      </a>
      <a href="#" class="bento-tile" style="grid-column:span 2; position:relative; overflow:hidden; border-radius:22px; display:block;" data-m="span tile">
        ...
        <div style="position:absolute; inset:0; background:linear-gradient(0deg, rgba(16,20,46,0.95) 0%, rgba(16,20,46,0.35) 65%, rgba(16,20,46,0.15) 100%);"></div>
        <div style="position:absolute; left:0; right:0; bottom:0; padding:26px 26px 26px 26px;"><h3 class="bebas" style="font-size:30px; margin:0px 0px 6px 0px; color:#F2F1F8;">BUSINESS AUDIT &amp; ADVISORY</h3><p style="font-size:13px; line-height:1.6; color:#C7C7DA; margin:0px 0px 0px 0px;">An honest look at what is working — and what to do next.</p></div>
      </a></div></sc-if>
  </section>

  <!-- 4 DIFFERENCE -->
  <section style="min-height:760px; padding:44px 20px 44px 20px; background:#F3F1FC;" data-m="nomin">
    <div style="text-align:center; margin-bottom:50px;" class="reveal"><span class="eyebrow">The Crux Nxtion Difference</span><h2 class="bebas" style="font-size:40px; margin:12px 0px 0px 0px; color:#10142E;">WHY PEOPLE COME BACK.</h2></div>
    <div style="display:grid; grid-template-columns:repeat(4, minmax(0, 1fr)); gap:18px;" class="reveal" data-m="g1">
      <div class="bento-tile reveal" style="background:#FFFFFF; border:1.5px solid #E1DEF3; border-radius:22px; padding:32px 28px 32px 28px; min-height:300px; display:flex; flex-direction:column; justify-content:space-between;"><span class="bebas" style="font-size:40px; color:#6C58DB; line-height:0.9;">01</span><div><h3 class="bebas" style="font-size:30px; margin:0px 0px 10px 0px; color:#10142E;">CLIENT-CENTRIC</h3><p style="font-size:14px; line-height:1.7; color:#3A3F66; margin:0px 0px 0px 0px;">A passion for creativity, pointed at your vision. We turn what you picture into what happens.</p></div></div>
      <div class="bento-tile reveal" style="background:#FFFFFF; border:1.5px solid #E1DEF3; border-radius:22px; padding:32px 28px 32px 28px; min-height:300px; display:flex; flex-direction:column; justify-content:space-between;"><span class="bebas" style="font-size:40px; color:#6C58DB; line-height:0.9;">02</span><div><h3 class="bebas" style="font-size:30px; margin:0px 0px 10px 0px; color:#10142E;">ONE-STOP SOLUTION</h3><p style="font-size:14px; line-height:1.7; color:#3A3F66; margin:0px 0px 0px 0px;">Planning, booking, design, promotion and on-the-day coordination under one roof.</p></div></div>
      <div class="bento-tile reveal" style="background:#FFFFFF; border:1.5px solid #E1DEF3; border-radius:22px; padding:32px 28px 32px 28px; min-height:300px; display:flex; flex-direction:column; justify-content:space-between;"><span class="bebas" style="font-size:40px; color:#6C58DB; line-height:0.9;">03</span><div><h3 class="bebas" style="font-size:30px; margin:0px 0px 10px 0px; color:#10142E;">DESTINATION-READY</h3><p style="font-size:14px; line-height:1.7; color:#3A3F66; margin:0px 0px 0px 0px;">Weddings and corporate retreats away from home, coordinated on the ground.</p></div></div>
      <div class="bento-tile reveal" style="background:#FFFFFF; border:1.5px solid #E1DEF3; border-radius:22px; padding:32px 28px 32px 28px; min-height:300px; display:flex; flex-direction:column; justify-content:space-between;"><span class="bebas" style="font-size:40px; color:#6C58DB; line-height:0.9;">04</span><div><h3 class="bebas" style="font-size:30px; margin:0px 0px 10px 0px; color:#10142E;">STRATEGY BEHIND THE PARTY</h3><p style="font-size:14px; line-height:1.7; color:#3A3F66; margin:0px 0px 0px 0px;">Our consultancy arm helps you build the business the event is for.</p></div></div>
    </div>
  </section>
  ...
  <section id="founder" style="padding:64px 20px; background:#111838; display:grid; grid-template-columns:0.8fr 1.2fr; gap:60px; align-items:center;" data-m="g1">
    ...
    <div class="reveal">
      ...
      <h2 class="bebas" style="font-size:62px; margin:14px 0 20px; color:#F4F5FA; line-height:0.95;">OLABAMIDELE "BAMBAD" BADMOS.</h2>
      <p style="font-size:16px; line-height:1.8; color:#C5CADF; max-width:620px; margin:0 0 14px;">Bambad is a business strategist and serial entrepreneur, and the Sheffield producer behind every Crux Nxtion night, known as the &ldquo;Oba of Events&rdquo;. He built the crew, set the standard and still leads it from the first brief to the last guest.</p>
      <p style="font-size:16px; line-height:1.8; color:#C5CADF; max-width:620px; margin:0 0 26px;">Weddings, cultural nights and private celebrations all get the same care, and through Crux Nxtion Consultancy the same thinking now goes to the businesses behind them. He also owns <a href="https://nxtionfoodmarket.com/" target="_blank" rel="noopener" style="color:#8C7AE6; text-decoration:underline;">Nxtion Food Market</a> in Sheffield and is expanding into franchising.</p>
      <div style="display:flex; gap:12px; flex-wrap:wrap; margin-bottom:28px;" data-m="wrap">
        <span style="border:1.5px solid #2C3C78; color:#D5D9EA; font-weight:600; font-size:12.5px; padding:9px 18px;">76+ events sold out</span>
        <span style="border:1.5px solid #2C3C78; color:#D5D9EA; font-weight:600; font-size:12.5px; padding:9px 18px;">Naija Food Carnival: 400+ guests</span>
        <span style="border:1.5px solid #2C3C78; color:#D5D9EA; font-weight:600; font-size:12.5px; padding:9px 18px;">Owner, Nxtion Food Market</span>
        <span style="border:1.5px solid #2C3C78; color:#D5D9EA; font-weight:600; font-size:12.5px; padding:9px 18px;">Serial entrepreneur</span>
      </div>
  ...
  <!-- 6 JOURNEY -->
  <section style="min-height:760px; padding:44px 20px 44px 20px; background:#F3F1FC;" data-m="nomin">
    <div style="margin-bottom:60px;" class="reveal"><span class="eyebrow">How We Got Here</span><h2 class="bebas" style="font-size:40px; margin:12px 0px 0px 0px; color:#10142E;">FROM THE DANCE FLOOR TO THE BOARDROOM.</h2></div>
    <div style="position:relative; display:grid; grid-template-columns:repeat(4, minmax(0, 1fr)); gap:22px;" class="reveal" data-m="g1">
      ...
      <div style="position:relative;" class="reveal"><div style="width:56px; height:56px; border-radius:50%; background:#F3F1FC; border:2px dashed #6C58DB; display:flex; align-items:center; justify-content:center; margin-bottom:22px; position:relative;"><span class="bebas" style="font-size:22px; color:#6C58DB;">1</span></div><div style="background:#FFFFFF; border:1.5px solid #E1DEF3; border-radius:18px; padding:24px 24px 24px 24px;"><h3 class="bebas" style="font-size:28px; margin:0px 0px 8px 0px; color:#10142E;">AN EVENTS CREW IN SHEFFIELD</h3><p style="font-size:13.5px; line-height:1.65; color:#3A3F66; margin:0px 0px 0px 0px;">Hangouts, weddings and dance nights, planned and run end to end.</p></div></div>
      <div style="position:relative;" class="reveal"><div style="width:56px; height:56px; border-radius:50%; background:#F3F1FC; border:2px dashed #6C58DB; display:flex; align-items:center; justify-content:center; margin-bottom:22px; position:relative;"><span class="bebas" style="font-size:22px; color:#6C58DB;">2</span></div><div style="background:#FFFFFF; border:1.5px solid #E1DEF3; border-radius:18px; padding:24px 24px 24px 24px;"><h3 class="bebas" style="font-size:28px; margin:0px 0px 8px 0px; color:#10142E;">76+ EVENTS SOLD OUT</h3><p style="font-size:13.5px; line-height:1.65; color:#3A3F66; margin:0px 0px 0px 0px;">A reputation for filling rooms across the UK.</p></div></div>
      <div style="position:relative;" class="reveal"><div style="width:56px; height:56px; border-radius:50%; background:#F3F1FC; border:2px dashed #6C58DB; display:flex; align-items:center; justify-content:center; margin-bottom:22px; position:relative;"><span class="bebas" style="font-size:22px; color:#6C58DB;">3</span></div><div style="background:#FFFFFF; border:1.5px solid #E1DEF3; border-radius:18px; padding:24px 24px 24px 24px;"><h3 class="bebas" style="font-size:28px; margin:0px 0px 8px 0px; color:#10142E;">NAIJA FOOD CARNIVAL</h3><p style="font-size:13.5px; line-height:1.65; color:#3A3F66; margin:0px 0px 0px 0px;">July 2024 · 400+ guests · 20+ vendors · 45+ dishes.</p></div></div>
      <div style="position:relative;" class="reveal"><div style="width:56px; height:56px; border-radius:50%; background:#F3F1FC; border:2px dashed #6C58DB; display:flex; align-items:center; justify-content:center; margin-bottom:22px; position:relative;"><span class="bebas" style="font-size:22px; color:#6C58DB;">4</span></div><div style="background:#FFFFFF; border:1.5px solid #E1DEF3; border-radius:18px; padding:24px 24px 24px 24px;"><h3 class="bebas" style="font-size:28px; margin:0px 0px 8px 0px; color:#10142E;">CRUX NXTION CONSULTANCY</h3><p style="font-size:13.5px; line-height:1.65; color:#3A3F66; margin:0px 0px 0px 0px;">Turning business ideas into businesses that work.</p></div></div>
    </div>
  </section>
