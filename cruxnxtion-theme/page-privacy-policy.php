...
<div style="width:100%; max-width:100%; margin:0; background:#FFFFFF; overflow-x:clip;" data-m="root">
  ...
  <section style=" padding:44px 20px 30px 20px; background:#F3F1FC; border-bottom:1px solid #E1DEF3;">
    ...
    <h1 class="bebas" style="font-size:44px; margin:14px 0px 14px 0px; color:#10142E;">PRIVACY POLICY</h1>
    <p style="font-size:15px; line-height:1.65; color:#5A5F86; max-width:640px; margin:0px 0px 6px 0px;" class="reveal">How Crux Nxtion Events collects, uses and protects your personal information. We keep it plain and short.</p>
  ...
  <section style=" padding:56px 20px 44px 20px; display:grid; grid-template-columns:280px 1fr; gap:64px; align-items:start;" data-m="g1">
    <div style="position:sticky; top:24px;" class="reveal" data-m="static"><div style="font-size:11px; letter-spacing:2.6px; font-weight:700; color:#6C58DB; margin-bottom:12px;">ON THIS PAGE</div><a href="#s1" style="display:block; font-size:14px; color:#5A5F86; padding:9px 0px 9px 14px; border-left:2px solid #E1DEF3;">1. Who we are</a><a href="#s2" style="display:block; font-size:14px; color:#5A5F86; padding:9px 0px 9px 14px; border-left:2px solid #E1DEF3;">2. What we collect</a><a href="#s3" style="display:block; font-size:14px; color:#5A5F86; padding:9px 0px 9px 14px; border-left:2px solid #E1DEF3;">3. How we use it</a><a href="#s4" style="display:block; font-size:14px; color:#5A5F86; padding:9px 0px 9px 14px; border-left:2px solid #E1DEF3;">4. Legal basis</a><a href="#s5" style="display:block; font-size:14px; color:#5A5F86; padding:9px 0px 9px 14px; border-left:2px solid #E1DEF3;">5. Who we share it with</a><a href="#s6" style="display:block; font-size:14px; color:#5A5F86; padding:9px 0px 9px 14px; border-left:2px solid #E1DEF3;">6. How long we keep it</a><a href="#s7" style="display:block; font-size:14px; color:#5A5F86; padding:9px 0px 9px 14px; border-left:2px solid #E1DEF3;">7. Your rights</a><a href="#s8" style="display:block; font-size:14px; color:#5A5F86; padding:9px 0px 9px 14px; border-left:2px solid #E1DEF3;">8. Changes to this policy</a>
    ...
    <div style="max-width:760px;" class="reveal">
      <div id="s1" style="margin-bottom:40px;"><h2 class="bebas" style="font-size:38px; margin:0px 0px 12px 0px; color:#10142E;">1. Who we are</h2><p style="font-size:15px; line-height:1.75; color:#3A3F66; margin:0px 0px 12px 0px;">Crux Nxtion Events is an events and business consultancy company based in Sheffield, United Kingdom (29 Dun Work, Sheffield S3 8FB, United Kingdom). We are the controller of the personal information described in this policy. You can reach us at <a href="<?php echo esc_url( 'mailto:' . antispambot( 'infoandsales@cruxnxtion.co.uk' ) ); ?>" style="color:#002671; font-weight:600; text-decoration:underline;"><?php echo esc_html( antispambot( 'infoandsales@cruxnxtion.co.uk' ) ); ?></a>.</p></div>
      <div id="s2" style="margin-bottom:40px;"><h2 class="bebas" style="font-size:38px; margin:0px 0px 12px 0px; color:#10142E;">2. What we collect</h2><p style="font-size:15px; line-height:1.75; color:#3A3F66; margin:0px 0px 12px 0px;">When you enquire, book or subscribe we collect your name, email address, phone number, the details of your event or business, and anything you choose to tell us.</p><p style="font-size:15px; line-height:1.75; color:#3A3F66; margin:0px 0px 12px 0px;">When you visit the website we collect basic technical data such as your IP address, browser and pages visited, through cookies and similar tools (see our Cookie Policy).</p><p style="font-size:15px; line-height:1.75; color:#3A3F66; margin:0px 0px 12px 0px;">If you buy tickets for one of our events through a third-party ticketing platform, that platform handles your payment details, not us.</p></div>
      <div id="s3" style="margin-bottom:40px;"><h2 class="bebas" style="font-size:38px; margin:0px 0px 12px 0px; color:#10142E;">3. How we use it</h2><p style="font-size:15px; line-height:1.75; color:#3A3F66; margin:0px 0px 12px 0px;">To reply to enquiries, plan and deliver events, and provide consultancy services.</p><p style="font-size:15px; line-height:1.75; color:#3A3F66; margin:0px 0px 12px 0px;">To send updates you have asked for. You can opt out at any time.</p><p style="font-size:15px; line-height:1.75; color:#3A3F66; margin:0px 0px 12px 0px;">To improve our website, to keep it secure and to meet legal obligations.</p></div>
      <div id="s4" style="margin-bottom:40px;"><h2 class="bebas" style="font-size:38px; margin:0px 0px 12px 0px; color:#10142E;">4. Legal basis</h2><p style="font-size:15px; line-height:1.75; color:#3A3F66; margin:0px 0px 12px 0px;">We rely on contract (to deliver what you have booked), legitimate interests (running and improving our business), consent (marketing and non-essential cookies) and legal obligation (for example, accounting records).</p></div>
      <div id="s5" style="margin-bottom:40px;"><h2 class="bebas" style="font-size:38px; margin:0px 0px 12px 0px; color:#10142E;">5. Who we share it with</h2><p style="font-size:15px; line-height:1.75; color:#3A3F66; margin:0px 0px 12px 0px;">Only people who help us deliver our services: venues, suppliers, ticketing and payment platforms, website hosting, analytics and email providers. We do not sell your personal information.</p></div>
      <div id="s6" style="margin-bottom:40px;"><h2 class="bebas" style="font-size:38px; margin:0px 0px 12px 0px; color:#10142E;">6. How long we keep it</h2><p style="font-size:15px; line-height:1.75; color:#3A3F66; margin:0px 0px 12px 0px;">Enquiry and booking records are kept for as long as needed to deliver the service and for up to six years afterwards for accounting and legal reasons. Marketing contacts are kept until you unsubscribe.</p></div>
      <div id="s7" style="margin-bottom:40px;"><h2 class="bebas" style="font-size:38px; margin:0px 0px 12px 0px; color:#10142E;">7. Your rights</h2><p style="font-size:15px; line-height:1.75; color:#3A3F66; margin:0px 0px 12px 0px;">Under UK GDPR you can ask to see, correct, delete or restrict the use of your information, object to certain uses, and request a copy of the data you gave us. You can also withdraw consent at any time.</p><p style="font-size:15px; line-height:1.75; color:#3A3F66; margin:0px 0px 12px 0px;">To use any of these rights, email <a href="<?php echo esc_url( 'mailto:' . antispambot( 'infoandsales@cruxnxtion.co.uk' ) ); ?>" style="color:#002671; font-weight:600; text-decoration:underline;"><?php echo esc_html( antispambot( 'infoandsales@cruxnxtion.co.uk' ) ); ?></a>. If you are unhappy with how we handle your data you can complain to the Information Commissioner's Office at ico.org.uk.</p></div>
      <div id="s8" style="margin-bottom:40px;"><h2 class="bebas" style="font-size:38px; margin:0px 0px 12px 0px; color:#10142E;">8. Changes to this policy</h2><p style="font-size:15px; line-height:1.75; color:#3A3F66; margin:0px 0px 12px 0px;">We may update this policy from time to time. The date at the top shows when it last changed.</p></div>
    </div>
  </section>
