...
<div style="width:100%; max-width:100%; margin:0; background:#0A0F26; overflow-x:clip;" data-m="root">
  ...
  <section style=" padding:44px 20px 50px 20px; display:grid; grid-template-columns:1.2fr 0.8fr; gap:60px; align-items:end;" data-m="g1">
    <div class="reveal"><span class="eyebrow">Event Services</span><h1 class="bebas" style="font-size:52px; margin:16px 0px 0px 0px; color:#F4F5FA;">FIVE SERVICES.<br><span style="color:#E5383B;">ONE CREW.</span></h1></div>
    <p style="font-size:16px; line-height:1.75; color:#C5CADF; margin:0px 0px 0px 0px;" class="reveal">Everything your event needs, from the first brief to the last guest leaving. Pick the one that sounds like your week — or tell us the date and we will work out the rest.</p>
  </section>
  ...
  <section style="min-height:560px; display:flex; flex-direction:column; justify-content:center; padding:20px 20px 44px 20px;" data-m="nomin"><div style="display:flex; flex-direction:column; gap:28px;" class="reveal">
      <div style="display:grid; grid-template-columns:0.9fr 1fr; background:#111838; border:1.5px solid #1E2B5E; border-radius:22px; overflow:hidden;" data-m="g1">
        ...
        <div style="order:2; padding:44px 20px 44px 20px;" class="reveal">
          <h3 class="bebas" style="font-size:34px; margin:0px 0px 18px 0px; color:#F4F5FA;">EVENT MANAGEMENT &amp; PLANNING</h3>
          <div style="background:#0A0F26; border:1.5px solid #1E2B5E; border-radius:14px 14px 14px 4px; padding:16px 18px 16px 18px; margin-bottom:12px;"><span style="font-size:10.5px; letter-spacing:1.5px; text-transform:uppercase; color:#5B8DEF; font-weight:700;">You might be planning</span><p style="font-size:16px; font-weight:600; margin:6px 0px 0px 0px; color:#F4F5FA;">A corporate function, a wedding celebration or a music festival — and no idea where to start.</p></div>
          <div style="background:#002671; border-radius:14px 14px 4px 14px; padding:16px 18px 16px 18px; margin-bottom:22px;"><span style="font-size:10.5px; letter-spacing:1.5px; text-transform:uppercase; color:#FFFFFF; font-weight:800;">We'll handle</span><p style="font-size:14.5px; line-height:1.6; font-weight:600; margin:6px 0px 0px 0px; color:#FFFFFF;">We coordinate every detail from concept to execution, so you are a guest at your own event.</p></div>
          <span class="eyebrow">You leave with</span>
          <div style="display:flex; gap:10px; flex-wrap:wrap; margin:12px 0px 18px 0px;" data-m="wrap"><span style="color:#D5D9EA; font-size:12px; font-weight:600; padding:8px 16px 8px 16px; --sl:6px; --bc:#2C3C78;" class="bx">A run of show</span><span style="color:#D5D9EA; font-size:12px; font-weight:600; padding:8px 16px 8px 16px; --sl:6px; --bc:#2C3C78;" class="bx">Vendors sorted</span><span style="color:#D5D9EA; font-size:12px; font-weight:600; padding:8px 16px 8px 16px; --sl:6px; --bc:#2C3C78;" class="bx">One point of contact</span></div>
          <p style="font-size:12.5px; color:#A3A9C8; margin:0px 0px 0px 0px;"><b style="letter-spacing:1.3px; color:#5B8DEF;">GOOD FOR</b> &nbsp;Conferences, seminars, product launches, weddings, birthdays, brand activations and galas.</p>
        </div>
      </div>
      <div style="display:grid; grid-template-columns:1fr 0.9fr; background:#111838; border:1.5px solid #1E2B5E; border-radius:22px; overflow:hidden;" data-m="g1">
        ...
        <div style="order:1; padding:44px 20px 44px 20px;">
          <h3 class="bebas" style="font-size:34px; margin:0px 0px 18px 0px; color:#F4F5FA;">ENTERTAINMENT BOOKING &amp; TALENT MANAGEMENT</h3>
          <div style="background:#0A0F26; border:1.5px solid #1E2B5E; border-radius:14px 14px 14px 4px; padding:16px 18px 16px 18px; margin-bottom:12px;"><span style="font-size:10.5px; letter-spacing:1.5px; text-transform:uppercase; color:#5B8DEF; font-weight:700;">You might be planning</span><p style="font-size:16px; font-weight:600; margin:6px 0px 0px 0px; color:#F4F5FA;">You want the night to feel like a show.</p></div>
          <div style="background:#002671; border-radius:14px 14px 4px 14px; padding:16px 18px 16px 18px; margin-bottom:22px;"><span style="font-size:10.5px; letter-spacing:1.5px; text-transform:uppercase; color:#FFFFFF; font-weight:800;">We'll handle</span><p style="font-size:14.5px; line-height:1.6; font-weight:600; margin:6px 0px 0px 0px; color:#FFFFFF;">We book performers, artists and entertainers who match your vibe — and keep an eye on who is current.</p></div>
          <span class="eyebrow">You leave with</span>
          <div style="display:flex; gap:10px; flex-wrap:wrap; margin:12px 0px 18px 0px;" data-m="wrap"><span style="color:#D5D9EA; font-size:12px; font-weight:600; padding:8px 16px 8px 16px; --sl:6px; --bc:#2C3C78;" class="bx">A shortlist of acts</span><span style="color:#D5D9EA; font-size:12px; font-weight:600; padding:8px 16px 8px 16px; --sl:6px; --bc:#2C3C78;" class="bx">Bookings &amp; logistics</span><span style="color:#D5D9EA; font-size:12px; font-weight:600; padding:8px 16px 8px 16px; --sl:6px; --bc:#2C3C78;" class="bx">Run-of-show timings</span></div>
          <p style="font-size:12.5px; color:#A3A9C8; margin:0px 0px 0px 0px;"><b style="letter-spacing:1.3px; color:#5B8DEF;">GOOD FOR</b> &nbsp;Private and corporate events, music concerts and festivals.</p>
        </div>
      </div>
      <div style="display:grid; grid-template-columns:0.9fr 1fr; background:#111838; border:1.5px solid #1E2B5E; border-radius:22px; overflow:hidden;" data-m="g1">
        ...
        <div style="order:2; padding:44px 20px 44px 20px;">
          <h3 class="bebas" style="font-size:34px; margin:0px 0px 18px 0px; color:#F4F5FA;">EVENT DESIGNS &amp; PRODUCTION</h3>
          <div style="background:#0A0F26; border:1.5px solid #1E2B5E; border-radius:14px 14px 14px 4px; padding:16px 18px 16px 18px; margin-bottom:12px;"><span style="font-size:10.5px; letter-spacing:1.5px; text-transform:uppercase; color:#5B8DEF; font-weight:700;">You might be planning</span><p style="font-size:16px; font-weight:600; margin:6px 0px 0px 0px; color:#F4F5FA;">You can picture it — you just cannot build it.</p></div>
          <div style="background:#002671; border-radius:14px 14px 4px 14px; padding:16px 18px 16px 18px; margin-bottom:22px;"><span style="font-size:10.5px; letter-spacing:1.5px; text-transform:uppercase; color:#FFFFFF; font-weight:800;">We'll handle</span><p style="font-size:14.5px; line-height:1.6; font-weight:600; margin:6px 0px 0px 0px; color:#FFFFFF;">We turn the vision into a themed, styled space: concept, décor, staging and lighting.</p></div>
          <span class="eyebrow">You leave with</span>
          <div style="display:flex; gap:10px; flex-wrap:wrap; margin:12px 0px 18px 0px;" data-m="wrap"><span style="color:#D5D9EA; font-size:12px; font-weight:600; padding:8px 16px 8px 16px; --sl:6px; --bc:#2C3C78;" class="bx">Concept &amp; mood</span><span style="color:#D5D9EA; font-size:12px; font-weight:600; padding:8px 16px 8px 16px; --sl:6px; --bc:#2C3C78;" class="bx">Décor &amp; styling</span><span style="color:#D5D9EA; font-size:12px; font-weight:600; padding:8px 16px 8px 16px; --sl:6px; --bc:#2C3C78;" class="bx">Staging</span></div>
          <p style="font-size:12.5px; color:#A3A9C8; margin:0px 0px 0px 0px;"><b style="letter-spacing:1.3px; color:#5B8DEF;">GOOD FOR</b> &nbsp;Weddings, engagement celebrations and birthday parties.</p>
        </div>
      </div>
      <div style="display:grid; grid-template-columns:1fr 0.9fr; background:#111838; border:1.5px solid #1E2B5E; border-radius:22px; overflow:hidden;" data-m="g1">
        <div style="order:2; position:relative; min-height:400px;" data-m="tile">
        ...
        <div style="order:1; padding:44px 20px 44px 20px;">
          <h3 class="bebas" style="font-size:34px; margin:0px 0px 18px 0px; color:#F4F5FA;">EVENT MARKETING &amp; PROMOTION</h3>
          <div style="background:#0A0F26; border:1.5px solid #1E2B5E; border-radius:14px 14px 14px 4px; padding:16px 18px 16px 18px; margin-bottom:12px;"><span style="font-size:10.5px; letter-spacing:1.5px; text-transform:uppercase; color:#5B8DEF; font-weight:700;">You might be planning</span><p style="font-size:16px; font-weight:600; margin:6px 0px 0px 0px; color:#F4F5FA;">The event is great. Nobody knows about it yet.</p></div>
          <div style="background:#002671; border-radius:14px 14px 4px 14px; padding:16px 18px 16px 18px; margin-bottom:22px;"><span style="font-size:10.5px; letter-spacing:1.5px; text-transform:uppercase; color:#FFFFFF; font-weight:800;">We'll handle</span><p style="font-size:14.5px; line-height:1.6; font-weight:600; margin:6px 0px 0px 0px; color:#FFFFFF;">Social campaigns, influencer partnerships, listings and offline promotion that build buzz and fill the room.</p></div>
          <span class="eyebrow">You leave with</span>
          <div style="display:flex; gap:10px; flex-wrap:wrap; margin:12px 0px 18px 0px;" data-m="wrap"><span style="color:#D5D9EA; font-size:12px; font-weight:600; padding:8px 16px 8px 16px; --sl:6px; --bc:#2C3C78;" class="bx">A campaign plan</span><span style="color:#D5D9EA; font-size:12px; font-weight:600; padding:8px 16px 8px 16px; --sl:6px; --bc:#2C3C78;" class="bx">Social &amp; influencer</span><span style="color:#D5D9EA; font-size:12px; font-weight:600; padding:8px 16px 8px 16px; --sl:6px; --bc:#2C3C78;" class="bx">Listings &amp; SEO</span></div>
          <p style="font-size:12.5px; color:#A3A9C8; margin:0px 0px 0px 0px;"><b style="letter-spacing:1.3px; color:#5B8DEF;">GOOD FOR</b> &nbsp;Music concerts, festivals and ticketed nights.</p>
        </div>
      </div>
      <div style="display:grid; grid-template-columns:0.9fr 1fr; background:#111838; border:1.5px solid #1E2B5E; border-radius:22px; overflow:hidden;" data-m="g1">
        <div style="order:1; position:relative; min-height:400px;" data-m="tile">
        ...
        <div style="order:2; padding:44px 20px 44px 20px;">
          <h3 class="bebas" style="font-size:34px; margin:0px 0px 18px 0px; color:#F4F5FA;">ON-SITE COORDINATION</h3>
          <div style="background:#0A0F26; border:1.5px solid #1E2B5E; border-radius:14px 14px 14px 4px; padding:16px 18px 16px 18px; margin-bottom:12px;"><span style="font-size:10.5px; letter-spacing:1.5px; text-transform:uppercase; color:#5B8DEF; font-weight:700;">You might be planning</span><p style="font-size:16px; font-weight:600; margin:6px 0px 0px 0px; color:#F4F5FA;">On the day, everything needs to just work.</p></div>
          <div style="background:#002671; border-radius:14px 14px 4px 14px; padding:16px 18px 16px 18px; margin-bottom:22px;"><span style="font-size:10.5px; letter-spacing:1.5px; text-transform:uppercase; color:#FFFFFF; font-weight:800;">We'll handle</span><p style="font-size:14.5px; line-height:1.6; font-weight:600; margin:6px 0px 0px 0px; color:#FFFFFF;">Real-time support, venue logistics and vendor management, start to close.</p></div>
          <span class="eyebrow">You leave with</span>
          <div style="display:flex; gap:10px; flex-wrap:wrap; margin:12px 0px 18px 0px;" data-m="wrap"><span style="color:#D5D9EA; font-size:12px; font-weight:600; padding:8px 16px 8px 16px; --sl:6px; --bc:#2C3C78;" class="bx">A floor team</span><span style="color:#D5D9EA; font-size:12px; font-weight:600; padding:8px 16px 8px 16px; --sl:6px; --bc:#2C3C78;" class="bx">Vendor management</span><span style="color:#D5D9EA; font-size:12px; font-weight:600; padding:8px 16px 8px 16px; --sl:6px; --bc:#2C3C78;" class="bx">Day-of management</span></div>
          <p style="font-size:12.5px; color:#A3A9C8; margin:0px 0px 0px 0px;"><b style="letter-spacing:1.3px; color:#5B8DEF;">GOOD FOR</b> &nbsp;Destination-packed events, large guest lists and multi-vendor productions.</p>
        </div>
      </div></div></section>
  ...
  <section style="min-height:560px; display:flex; flex-direction:column; justify-content:center; padding:44px 20px 44px 20px;" data-m="nomin">
    ...
    <div style="position:relative; display:grid; grid-template-columns:repeat(4, minmax(0, 1fr)); gap:26px;" class="reveal" data-m="g1">
      <div class="tilt-ticket reveal" style="display:flex; flex-direction:column; background:#111838; border:1.5px solid #1E2B5E; border-radius:14px; overflow:hidden; --r:-1deg; transform:rotate(var(--r));">
        ...
        <div class="strip-stub" style="background:#8C7AE6; padding:12px 18px 12px 18px; display:flex; justify-content:space-between; align-items:center;"><span style="font-size:12px; font-weight:800; color:#0A0F26;">STEP 01</span><span class="bebas" style="font-size:18px; color:#0A0F26;">BRIEF</span></div>
      ...
      <div class="tilt-ticket reveal" style="display:flex; flex-direction:column; background:#111838; border:1.5px solid #1E2B5E; border-radius:14px; overflow:hidden; --r:0.8deg; transform:rotate(var(--r));">
        ...
        <div class="strip-stub" style="background:#002671; padding:12px 18px 12px 18px; display:flex; justify-content:space-between; align-items:center;"><span style="font-size:12px; font-weight:800; color:#FFFFFF;">STEP 02</span><span class="bebas" style="font-size:18px; color:#FFFFFF;">DESIGN</span></div>
      ...
      <div class="tilt-ticket reveal" style="display:flex; flex-direction:column; background:#111838; border:1.5px solid #1E2B5E; border-radius:14px; overflow:hidden; --r:-0.8deg; transform:rotate(var(--r));">
        ...
        <div class="strip-stub" style="background:#BA0000; padding:12px 18px 12px 18px; display:flex; justify-content:space-between; align-items:center;"><span style="font-size:12px; font-weight:800; color:#FFFFFF;">STEP 03</span><span class="bebas" style="font-size:18px; color:#FFFFFF;">PRODUCE</span></div>
      ...
      <div class="tilt-ticket reveal" style="display:flex; flex-direction:column; background:#111838; border:1.5px solid #1E2B5E; border-radius:14px; overflow:hidden; --r:1deg; transform:rotate(var(--r));">
        ...
        <div class="strip-stub" style="background:#8C7AE6; padding:12px 18px 12px 18px; display:flex; justify-content:space-between; align-items:center;"><span style="font-size:12px; font-weight:800; color:#0A0F26;">STEP 04</span><span class="bebas" style="font-size:18px; color:#0A0F26;">DELIVER</span></div>
