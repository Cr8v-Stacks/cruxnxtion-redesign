...
<div style="width:100%; max-width:100%; margin:0; background:#0A0F26; overflow-x:clip;" data-m="root">
  ...
  <section style=" padding:44px 20px 20px 20px;">
    ...
    <h1 class="bebas" style="font-size:44px; margin:14px 0px 14px 0px; color:#F4F5FA;">THE JOURNAL</h1>
  ...
  <section style="min-height:560px; display:flex; flex-direction:column; justify-content:center; padding:30px 20px 44px 20px;" data-m="nomin">
    <div style="display:grid; grid-template-columns:repeat(3, minmax(0, 1fr)); gap:26px;" class="reveal" data-m="g1">
      <a href="<?php echo esc_url( home_url( "/blog/behind-dance-out-2023/" ) ); ?>" class="ticket reveal" style="grid-column:span 3; display:flex; background:#111838; border:1.5px solid #1E2B5E; border-radius:12px; min-height:340px; overflow:hidden;" data-m="span tile">
        <div class="ticket-stub" style="flex:0 0 110px; background:#002671; display:flex; align-items:center; justify-content:center;"><span class="bebas" style="font-size:16px; color:#FFFFFF; writing-mode:vertical-rl; letter-spacing:2px;">FEATURED</span></div>
        ...
        <div style="position:absolute; left:0; top:0; bottom:0; display:flex; flex-direction:column; justify-content:center; padding:36px 36px 36px 36px; max-width:580px;"><span class="eyebrow">Event Recap</span><h2 class="bebas" style="font-size:38px; margin:12px 0px 12px 0px; color:#F4F5FA;">BEHIND DANCE OUT 2023: HOW WE FILL A DANCE FLOOR</h2><p style="font-size:14px; color:#C5CFF5; line-height:1.6; margin:0px 0px 16px 0px;">A behind-the-scenes look at how one crew plans, books and runs a night built to keep people moving.</p><span style="font-weight:700; font-size:12.5px; color:#5B8DEF; border-bottom:1.5px solid #5B8DEF; padding-bottom:2px; width:fit-content;">Read The Story →</span></div></div>
      </a>
      <a href="<?php echo esc_url( home_url( "/blog/planning-a-nigerian-wedding-party-in-the-uk/" ) ); ?>" class="ticket reveal" style="display:flex; background:#111838; border:1.5px solid #1E2B5E; border-radius:12px; min-height:340px; overflow:hidden;" data-m="tile">
        <div class="ticket-stub" style="flex:0 0 60px; background:#BA0000; display:flex; align-items:center; justify-content:center;"><span class="bebas" style="font-size:13px; color:#FFFFFF; writing-mode:vertical-rl; letter-spacing:2px;">GUIDES</span></div>
        ...
        <div style="position:absolute; left:0; right:0; bottom:0; padding:20px 20px 20px 20px;"><span class="eyebrow">Guides</span><h3 style="font-size:17px; margin:8px 0px 6px 0px; font-weight:700; color:#F4F5FA;">Planning A Nigerian Wedding Party In The UK</h3><span style="font-size:11.5px; color:#C5CFF5;">7 min read</span></div></div>
      </a>
      <a href="<?php echo esc_url( home_url( "/blog/what-entertainment-booking-really-involves/" ) ); ?>" class="ticket reveal" style="display:flex; background:#111838; border:1.5px solid #1E2B5E; border-radius:12px; min-height:340px; overflow:hidden;" data-m="tile">
        <div class="ticket-stub" style="flex:0 0 60px; background:#8C7AE6; display:flex; align-items:center; justify-content:center;"><span class="bebas" style="font-size:13px; color:#0A0F26; writing-mode:vertical-rl; letter-spacing:2px;">NOTES</span></div>
        ...
        <div style="position:absolute; left:0; right:0; bottom:0; padding:20px 20px 20px 20px;"><span class="eyebrow">Behind The Scenes</span><h3 style="font-size:17px; margin:8px 0px 6px 0px; font-weight:700; color:#F4F5FA;">What Entertainment Booking Really Involves</h3><span style="font-size:11.5px; color:#C5CFF5;">6 min read</span></div></div>
      </a>
      <a href="<?php echo esc_url( home_url( "/blog/how-far-ahead-should-you-book-your-event/" ) ); ?>" class="ticket reveal" style="display:flex; background:#111838; border:1.5px solid #1E2B5E; border-radius:12px; min-height:340px; overflow:hidden;" data-m="tile">
        <div class="ticket-stub" style="flex:0 0 60px; background:#002671; display:flex; align-items:center; justify-content:center;"><span class="bebas" style="font-size:13px; color:#FFFFFF; writing-mode:vertical-rl; letter-spacing:2px;">GUIDES</span></div>
        ...
        <div style="position:absolute; left:0; right:0; bottom:0; padding:20px 20px 20px 20px;"><span class="eyebrow">Guides</span><h3 style="font-size:17px; margin:8px 0px 6px 0px; font-weight:700; color:#F4F5FA;">How Far Ahead Should You Book Your Event?</h3><span style="font-size:11.5px; color:#C5CFF5;">5 min read</span></div></div>
      </a>
      <a href="<?php echo esc_url( home_url( "/blog/from-events-crew-to-consultancy/" ) ); ?>" class="ticket reveal" style="display:flex; background:#111838; border:1.5px solid #1E2B5E; border-radius:12px; min-height:340px; overflow:hidden;" data-m="tile">
        <div class="ticket-stub" style="flex:0 0 60px; background:#BA0000; display:flex; align-items:center; justify-content:center;"><span class="bebas" style="font-size:13px; color:#FFFFFF; writing-mode:vertical-rl; letter-spacing:2px;">STORY</span></div>
        ...
        <div style="position:absolute; left:0; right:0; bottom:0; padding:20px 20px 20px 20px;"><span class="eyebrow">Our Story</span><h3 style="font-size:17px; margin:8px 0px 6px 0px; font-weight:700; color:#F4F5FA;">From Events Crew To Consultancy: Why We Started</h3><span style="font-size:11.5px; color:#C5CFF5;">8 min read</span></div></div>
      </a>
      <a href="<?php echo esc_url( home_url( "/blog/ankara-festival-in-photos/" ) ); ?>" class="ticket reveal" style="display:flex; background:#111838; border:1.5px solid #1E2B5E; border-radius:12px; min-height:340px; overflow:hidden;" data-m="tile">
        <div class="ticket-stub" style="flex:0 0 60px; background:#8C7AE6; display:flex; align-items:center; justify-content:center;"><span class="bebas" style="font-size:13px; color:#0A0F26; writing-mode:vertical-rl; letter-spacing:2px;">RECAP</span></div>
        ...
        <div style="position:absolute; left:0; right:0; bottom:0; padding:20px 20px 20px 20px;"><span class="eyebrow">Event Recap</span><h3 style="font-size:17px; margin:8px 0px 6px 0px; font-weight:700; color:#F4F5FA;">Ankara Festival, In Photos</h3><span style="font-size:11.5px; color:#C5CFF5;">4 min read</span></div></div>
      </a>
      <div style="grid-column:span 3; display:flex; align-items:center; justify-content:space-between; background:#111838; border:1.5px solid #1E2B5E; border-radius:12px; padding:32px 36px 32px 36px;" class="reveal" data-m="span"><div><span class="eyebrow">Have A Story We Should Cover?</span><h3 class="bebas" style="font-size:28px; margin:10px 0px 0px 0px; color:#F4F5FA;">SEND US A NOTE</h3></div><a href="<?php echo esc_url( home_url( "/contact/" ) ); ?>" style="background:#BA0000; color:#FFFFFF; font-weight:700; font-size:13.5px; padding:14px 26px 14px 26px; --sl:10px;" class="bx">Get In Touch</a></div>
    </div>
  </section>
