...
<div style="width:100%; max-width:100%; margin:0; background:#FFFFFF; overflow-x:clip;" data-m="root">
  ...
  <header style="position:sticky; top:0; z-index:1000; display:flex; align-items:center; justify-content:space-between; padding:0 20px; border-bottom:1px solid rgba(225,222,243,0.85); background:rgba(255,255,255,0.95); backdrop-filter:blur(14px); -webkit-backdrop-filter:blur(14px);">
    ...
    <nav style="display:flex; align-items:center; gap:28px;">
      <a href="<?php echo esc_url( home_url( "/consultancy/" ) ); ?>" style="color:#10142E; font-size:14px; font-weight:600; letter-spacing:0.2px;">Home</a>
  ...
  <section style=" padding:44px 20px 50px 20px; display:grid; grid-template-columns:1.2fr 0.8fr; gap:60px; align-items:end;" data-m="g1">
    <div class="reveal"><span class="eyebrow">Consultancy Services</span><h1 class="bebas" style="font-size:52px; margin:16px 0px 0px 0px; color:#10142E;">FIVE WAYS<br><span style="color:#6C58DB;">WE HELP.</span></h1></div>
    <p style="font-size:16px; line-height:1.75; color:#3A3F66; margin:0px 0px 0px 0px;" class="reveal">Each one starts with a conversation and ends with a plan you can act on. Pick the one that sounds like your week — or book a call and we'll work out which fits.</p>
  </section>
  <section style=" padding:20px 20px 44px 20px;"><div style="display:flex; flex-direction:column; gap:28px;" class="reveal">
      <div style="display:grid; grid-template-columns:0.9fr 1fr; background:#F3F1FC; border:1.5px solid #E1DEF3; border-radius:22px; overflow:hidden;" data-m="g1">
        <div style="order:1; position:relative; min-height:400px;" class="reveal" data-m="tile">
          ...
          <div class="ticket-stub" style="position:absolute; left:0; top:36px; background:#8C7AE6; padding:14px 22px 14px 26px; border-radius:0 10px 10px 0;"><span class="bebas" style="font-size:30px; color:#10142E;">01 / START</span></div>
        </div>
        <div style="order:2; padding:44px 20px 44px 20px;" class="reveal">
          <h3 class="bebas" style="font-size:34px; margin:0px 0px 18px 0px; color:#10142E;">BUSINESS SETUP &amp; STRATEGY</h3>
          <div style="background:#FFFFFF; border:1.5px solid #E1DEF3; border-radius:14px 14px 14px 4px; padding:16px 18px 16px 18px; margin-bottom:12px;"><span style="font-size:10.5px; letter-spacing:1.5px; text-transform:uppercase; color:#D9182A; font-weight:700;">You might be saying</span><p style="font-size:16px; font-weight:600; margin:6px 0px 0px 0px; color:#10142E;">Starting from scratch and not sure what the business should even look like?</p></div>
          <div style="background:#8C7AE6; border-radius:14px 14px 4px 14px; padding:16px 18px 16px 18px; margin-bottom:22px;"><span style="font-size:10.5px; letter-spacing:1.5px; text-transform:uppercase; color:#10142E; font-weight:800;">We'll say</span><p style="font-size:14.5px; line-height:1.6; font-weight:600; margin:6px 0px 0px 0px; color:#10142E;">We work out the model, the positioning and the operating plan — then a launch plan you can follow.</p></div>
          <p style="font-size:14px; line-height:1.75; color:#3A3F66; margin:0px 0px 20px 0px;">Every business starts as a rough idea. We help you pressure-test it, decide who it is for, price it sensibly and set up the structure to run it — so launch day feels like the next step, not a leap.</p>
          <span class="eyebrow">You leave with</span>
          <div style="display:flex; gap:10px; flex-wrap:wrap; margin-top:12px;" data-m="wrap"><span style="color:#3A3F66; font-size:12px; font-weight:600; padding:8px 16px 8px 16px; --sl:6px; --bc:#D2CEEA;" class="bx">A clear business model</span><span style="color:#3A3F66; font-size:12px; font-weight:600; padding:8px 16px 8px 16px; --sl:6px; --bc:#D2CEEA;" class="bx">Positioning that makes sense</span><span style="color:#3A3F66; font-size:12px; font-weight:600; padding:8px 16px 8px 16px; --sl:6px; --bc:#D2CEEA;" class="bx">A step-by-step launch plan</span></div>
          <p style="font-size:12.5px; color:#5A5F86; margin:18px 0px 0px 0px;"><b style="letter-spacing:1.3px; color:#6C58DB;">GOOD FOR</b> &nbsp;First-time founders, side hustles going full-time, new product lines.</p>
        </div>
      </div>
      <div style="display:grid; grid-template-columns:1fr 0.9fr; background:#F3F1FC; border:1.5px solid #E1DEF3; border-radius:22px; overflow:hidden;" data-m="g1">
        <div style="order:2; position:relative; min-height:400px;" data-m="tile">
          ...
          <div style="position:absolute; inset:0; background:linear-gradient(160deg, rgba(140,122,230,0.3) 0%, rgba(16,20,46,0.55) 100%);"></div>
          <div class="ticket-stub" style="position:absolute; left:0; top:36px; background:#8C7AE6; padding:14px 22px 14px 26px; border-radius:0 10px 10px 0;"><span class="bebas" style="font-size:30px; color:#10142E;">02 / BRAND</span></div>
        </div>
        <div style="order:1; padding:44px 20px 44px 20px;">
          <h3 class="bebas" style="font-size:34px; margin:0px 0px 18px 0px; color:#10142E;">BRANDING &amp; MARKETING</h3>
          <div style="background:#FFFFFF; border:1.5px solid #E1DEF3; border-radius:14px 14px 14px 4px; padding:16px 18px 16px 18px; margin-bottom:12px;"><span style="font-size:10.5px; letter-spacing:1.5px; text-transform:uppercase; color:#D9182A; font-weight:700;">You might be saying</span><p style="font-size:16px; font-weight:600; margin:6px 0px 0px 0px; color:#10142E;">You do good work, but your brand doesn't say so.</p></div>
          <div style="background:#8C7AE6; border-radius:14px 14px 4px 14px; padding:16px 18px 16px 18px; margin-bottom:22px;"><span style="font-size:10.5px; letter-spacing:1.5px; text-transform:uppercase; color:#10142E; font-weight:800;">We'll say</span><p style="font-size:14.5px; line-height:1.6; font-weight:600; margin:6px 0px 0px 0px; color:#10142E;">We sharpen the identity and the message, then build a marketing plan that fits your real budget.</p></div>
          <p style="font-size:14px; line-height:1.75; color:#3A3F66; margin:0px 0px 20px 0px;">Good work deserves a brand that says so. We define your voice, your look and your message, then turn it into a marketing plan sized to your real budget — social, local, partnerships and word of mouth.</p>
          <span class="eyebrow">You leave with</span>
          <div style="display:flex; gap:10px; flex-wrap:wrap; margin-top:12px;" data-m="wrap"><span style="color:#3A3F66; font-size:12px; font-weight:600; padding:8px 16px 8px 16px; --sl:6px; --bc:#D2CEEA;" class="bx">Identity and messaging</span><span style="color:#3A3F66; font-size:12px; font-weight:600; padding:8px 16px 8px 16px; --sl:6px; --bc:#D2CEEA;" class="bx">A go-to-market plan</span><span style="color:#3A3F66; font-size:12px; font-weight:600; padding:8px 16px 8px 16px; --sl:6px; --bc:#D2CEEA;" class="bx">A brand you can brief anyone on</span></div>
          <p style="font-size:12.5px; color:#5A5F86; margin:18px 0px 0px 0px;"><b style="letter-spacing:1.3px; color:#6C58DB;">GOOD FOR</b> &nbsp;Businesses that look smaller than they are, rebrands, new launches.</p>
        </div>
      </div>
      <div style="display:grid; grid-template-columns:0.9fr 1fr; background:#F3F1FC; border:1.5px solid #E1DEF3; border-radius:22px; overflow:hidden;" data-m="g1">
        <div style="order:1; position:relative; min-height:400px;" data-m="tile">
          ...
          <div style="position:absolute; inset:0; background:linear-gradient(160deg, rgba(140,122,230,0.3) 0%, rgba(16,20,46,0.55) 100%);"></div>
          <div class="ticket-stub" style="position:absolute; left:0; top:36px; background:#8C7AE6; padding:14px 22px 14px 26px; border-radius:0 10px 10px 0;"><span class="bebas" style="font-size:30px; color:#10142E;">03 / GROW</span></div>
        </div>
        <div style="order:2; padding:44px 20px 44px 20px;">
          <h3 class="bebas" style="font-size:34px; margin:0px 0px 18px 0px; color:#10142E;">BUSINESS GROWTH</h3>
          <div style="background:#FFFFFF; border:1.5px solid #E1DEF3; border-radius:14px 14px 14px 4px; padding:16px 18px 16px 18px; margin-bottom:12px;"><span style="font-size:10.5px; letter-spacing:1.5px; text-transform:uppercase; color:#D9182A; font-weight:700;">You might be saying</span><p style="font-size:16px; font-weight:600; margin:6px 0px 0px 0px; color:#10142E;">Busy, but the business isn't really growing.</p></div>
          <div style="background:#8C7AE6; border-radius:14px 14px 4px 14px; padding:16px 18px 16px 18px; margin-bottom:22px;"><span style="font-size:10.5px; letter-spacing:1.5px; text-transform:uppercase; color:#10142E; font-weight:800;">We'll say</span><p style="font-size:14.5px; line-height:1.6; font-weight:600; margin:6px 0px 0px 0px; color:#10142E;">We find the constraint, design the offer and map a realistic route to more customers and revenue.</p></div>
          <p style="font-size:14px; line-height:1.75; color:#3A3F66; margin:0px 0px 20px 0px;">Growth is rarely one big idea — it is the right few moves in the right order. We find what is capping your revenue, sharpen the offer and build a simple pipeline you can keep feeding.</p>
          <span class="eyebrow">You leave with</span>
          <div style="display:flex; gap:10px; flex-wrap:wrap; margin-top:12px;" data-m="wrap"><span style="color:#3A3F66; font-size:12px; font-weight:600; padding:8px 16px 8px 16px; --sl:6px; --bc:#D2CEEA;" class="bx">A growth plan with priorities</span><span style="color:#3A3F66; font-size:12px; font-weight:600; padding:8px 16px 8px 16px; --sl:6px; --bc:#D2CEEA;" class="bx">A sharper offer</span><span style="color:#3A3F66; font-size:12px; font-weight:600; padding:8px 16px 8px 16px; --sl:6px; --bc:#D2CEEA;" class="bx">A simple pipeline</span></div>
          <p style="font-size:12.5px; color:#5A5F86; margin:18px 0px 0px 0px;"><b style="letter-spacing:1.3px; color:#6C58DB;">GOOD FOR</b> &nbsp;Established businesses stuck on a plateau.</p>
        </div>
      </div>
      <div style="display:grid; grid-template-columns:1fr 0.9fr; background:#F3F1FC; border:1.5px solid #E1DEF3; border-radius:22px; overflow:hidden;" data-m="g1">
        <div style="order:2; position:relative; min-height:400px;" data-m="tile">
          ...
          <div style="position:absolute; inset:0; background:linear-gradient(160deg, rgba(140,122,230,0.3) 0%, rgba(16,20,46,0.55) 100%);"></div>
          <div class="ticket-stub" style="position:absolute; left:0; top:36px; background:#8C7AE6; padding:14px 22px 14px 26px; border-radius:0 10px 10px 0;"><span class="bebas" style="font-size:30px; color:#10142E;">04 / ACTIVATE</span></div>
        </div>
        <div style="order:1; padding:44px 20px 44px 20px;">
          <h3 class="bebas" style="font-size:34px; margin:0px 0px 18px 0px; color:#10142E;">ACTIVATION GROWTH</h3>
          <div style="background:#FFFFFF; border:1.5px solid #E1DEF3; border-radius:14px 14px 14px 4px; padding:16px 18px 16px 18px; margin-bottom:12px;"><span style="font-size:10.5px; letter-spacing:1.5px; text-transform:uppercase; color:#D9182A; font-weight:700;">You might be saying</span><p style="font-size:16px; font-weight:600; margin:6px 0px 0px 0px; color:#10142E;">People know you — they just don't act.</p></div>
          <div style="background:#8C7AE6; border-radius:14px 14px 4px 14px; padding:16px 18px 16px 18px; margin-bottom:22px;"><span style="font-size:10.5px; letter-spacing:1.5px; text-transform:uppercase; color:#10142E; font-weight:800;">We'll say</span><p style="font-size:14.5px; line-height:1.6; font-weight:600; margin:6px 0px 0px 0px; color:#10142E;">We design campaigns and activations that turn an audience into customers, and help you run them.</p></div>
          <p style="font-size:14px; line-height:1.75; color:#3A3F66; margin:0px 0px 20px 0px;">Some businesses have the audience but not the action. We design campaigns, live activations and partnerships that turn attention into enquiries and sales — drawing on years of getting crowds into rooms.</p>
          <span class="eyebrow">You leave with</span>
          <div style="display:flex; gap:10px; flex-wrap:wrap; margin-top:12px;" data-m="wrap"><span style="color:#3A3F66; font-size:12px; font-weight:600; padding:8px 16px 8px 16px; --sl:6px; --bc:#D2CEEA;" class="bx">Campaign concepts</span><span style="color:#3A3F66; font-size:12px; font-weight:600; padding:8px 16px 8px 16px; --sl:6px; --bc:#D2CEEA;" class="bx">Live activation ideas</span><span style="color:#3A3F66; font-size:12px; font-weight:600; padding:8px 16px 8px 16px; --sl:6px; --bc:#D2CEEA;" class="bx">Partnerships to pursue</span></div>
          <p style="font-size:12.5px; color:#5A5F86; margin:18px 0px 0px 0px;"><b style="letter-spacing:1.3px; color:#6C58DB;">GOOD FOR</b> &nbsp;Retail, food, hospitality and community brands.</p>
        </div>
      </div>
      <div style="display:grid; grid-template-columns:0.9fr 1fr; background:#F3F1FC; border:1.5px solid #E1DEF3; border-radius:22px; overflow:hidden;" data-m="g1">
        <div style="order:1; position:relative; min-height:400px;" data-m="tile">
          ...
          <div style="position:absolute; inset:0; background:linear-gradient(160deg, rgba(140,122,230,0.3) 0%, rgba(16,20,46,0.55) 100%);"></div>
          <div class="ticket-stub" style="position:absolute; left:0; top:36px; background:#8C7AE6; padding:14px 22px 14px 26px; border-radius:0 10px 10px 0;"><span class="bebas" style="font-size:30px; color:#10142E;">05 / AUDIT</span></div>
        </div>
        <div style="order:2; padding:44px 20px 44px 20px;">
          <h3 class="bebas" style="font-size:34px; margin:0px 0px 18px 0px; color:#10142E;">BUSINESS AUDIT &amp; ADVISORY</h3>
          <div style="background:#FFFFFF; border:1.5px solid #E1DEF3; border-radius:14px 14px 14px 4px; padding:16px 18px 16px 18px; margin-bottom:12px;"><span style="font-size:10.5px; letter-spacing:1.5px; text-transform:uppercase; color:#D9182A; font-weight:700;">You might be saying</span><p style="font-size:16px; font-weight:600; margin:6px 0px 0px 0px; color:#10142E;">You want an honest second opinion.</p></div>
          <div style="background:#8C7AE6; border-radius:14px 14px 4px 14px; padding:16px 18px 16px 18px; margin-bottom:22px;"><span style="font-size:10.5px; letter-spacing:1.5px; text-transform:uppercase; color:#10142E; font-weight:800;">We'll say</span><p style="font-size:14.5px; line-height:1.6; font-weight:600; margin:6px 0px 0px 0px; color:#10142E;">We look at the whole business, tell you what's working and what isn't, and recommend the next move.</p></div>
          <p style="font-size:14px; line-height:1.75; color:#3A3F66; margin:0px 0px 20px 0px;">An outside view is hard to get from the inside. We audit your offer, brand, numbers and customers, tell you plainly what is working and what is not, and hand you a prioritised action plan.</p>
          <span class="eyebrow">You leave with</span>
          <div style="display:flex; gap:10px; flex-wrap:wrap; margin-top:12px;" data-m="wrap"><span style="color:#3A3F66; font-size:12px; font-weight:600; padding:8px 16px 8px 16px; --sl:6px; --bc:#D2CEEA;" class="bx">An honest audit</span><span style="color:#3A3F66; font-size:12px; font-weight:600; padding:8px 16px 8px 16px; --sl:6px; --bc:#D2CEEA;" class="bx">What to fix first</span><span style="color:#3A3F66; font-size:12px; font-weight:600; padding:8px 16px 8px 16px; --sl:6px; --bc:#D2CEEA;" class="bx">An action plan</span></div>
          <p style="font-size:12.5px; color:#5A5F86; margin:18px 0px 0px 0px;"><b style="letter-spacing:1.3px; color:#6C58DB;">GOOD FOR</b> &nbsp;Owners who want a second opinion before the next big decision.</p>
        </div>
      </div></div></section>
    ...
    <div style="position:relative; z-index:1; width:100%; display:flex; justify-content:space-between; align-items:center; gap:40px; padding:0 64px; flex-wrap:wrap;" class="reveal" data-m="prefooter-inner">
      <div style="max-width:760px; padding:40px 0;">
        ...
        <div style="display:flex; gap:16px;" data-m="ctas">
          ...
          <a href="https://calendly.com/cruxnxtiongroupofcompany-info" target="_blank" rel="noopener" style="background:#8C7AE6; color:#10142E !important; font-weight:700; font-size:15px; padding:17px 32px; --sl:10px;" class="bx">Talk Business Strategy →</a>
        </div>
      </div>
      <div class="prefooter__badge" style="width:160px; height:160px; flex:0 0 160px;">
        <a href="https://calendly.com/cruxnxtiongroupofcompany-info" target="_blank" rel="noopener" class="prefooter__badge-link" aria-label="Book Discovery Call" style="display:block; width:100%; height:100%; text-decoration:none; transition:transform .3s ease;">
