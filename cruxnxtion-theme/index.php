...
<div style="width:100%; max-width:100%; margin:0; background:#0A0F26; overflow-x:clip;" data-m="root">
  ...
  <header style="position:sticky; top:0; z-index:1000; display:flex; align-items:center; justify-content:space-between; padding:0 20px; border-bottom:1px solid rgba(30,43,94,0.85); background:rgba(10,15,38,0.94); backdrop-filter:blur(14px); -webkit-backdrop-filter:blur(14px);">
    ...
    <nav style="display:flex; align-items:center; gap:28px;">
      <a href="<?php echo esc_url( home_url( "/" ) ); ?>" style="color:#5B8DEF; font-size:14px; font-weight:600; letter-spacing:0.2px; border-bottom:1.5px solid #5B8DEF;">Home</a>
  ...
  <section id="events" style="min-height:560px; display:flex; flex-direction:column; justify-content:center; padding:20px 20px 44px 20px;" data-m="nomin">
    ...
    <div style="display:grid; grid-template-columns:repeat(3, minmax(0, 1fr)); gap:22px;" data-m="g1">
      <a href="<?php echo esc_url( home_url( "/event/dance-out-2023/" ) ); ?>" class="tilt-ticket" style="display:flex; background:#111838; border:1.5px solid #1E2B5E; border-radius:12px; min-height:330px; --r:-1deg; transform:rotate(var(--r)); overflow:hidden;" data-m="tile">
      ...
      <a href="<?php echo esc_url( home_url( "/event/dance-out-2023/" ) ); ?>" class="tilt-ticket" style="display:flex; background:#111838; border:1.5px solid #1E2B5E; border-radius:12px; min-height:330px; --r:0.8deg; transform:rotate(var(--r)); overflow:hidden;" data-m="tile">
