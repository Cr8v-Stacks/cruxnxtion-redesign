...
<div style="width:100%; max-width:100%; margin:0; background:#FFFFFF; overflow-x:clip;" data-m="root">
  ...
  <header style="position:sticky; top:0; z-index:1000; display:flex; align-items:center; justify-content:space-between; padding:0 20px; border-bottom:1px solid rgba(225,222,243,0.85); background:rgba(255,255,255,0.95); backdrop-filter:blur(14px); -webkit-backdrop-filter:blur(14px);">
    ...
    <nav style="display:flex; align-items:center; gap:28px;">
      ...
      <a href="<?php echo esc_url( home_url( "/founder/" ) ); ?>" style="color:#6C58DB; font-size:14px; font-weight:600; letter-spacing:0.2px; border-bottom:1.5px solid #6C58DB;">Founder</a>
  ...
  <section style="padding:54px 20px 54px 20px; display:grid; grid-template-columns:0.82fr 1.18fr; gap:64px; align-items:center;" data-m="g1">
    ...
    <div class="reveal">
      <span class="eyebrow" style="color:#6C58DB;">About Crux Nxtion Events &amp; Consultancy</span>
      <h1 class="bebas" style="font-size:52px; margin:14px 0px 8px 0px; color:#10142E; line-height:0.95;">MEET THE TEAM</h1>
      <p style="font-size:14px; font-weight:700; letter-spacing:1.8px; text-transform:uppercase; color:#5A5F86; margin:0px 0px 22px 0px;">Led by Olabamidele Badmos (Bambad) • Backed by 10 Active Core Members &amp; Specialized Staff</p>
      
      <p style="font-size:16.5px; line-height:1.8; color:#3A3F66; max-width:620px; margin:0px 0px 20px 0px;">Our dynamic operations are led by Olabamidele Badmos (Bambad), a recognized community leader and business strategic development officer with extensive expertise in enterprise growth, marketing, and digital public relations. Backed by a dedicated team of 10 active core members and specialized staff, we combine creative production with deep commercial discipline to deliver exceptional results for every client we serve.</p>

      <div style="display:flex; gap:10px; flex-wrap:wrap; margin-bottom:28px;" data-m="wrap">
        <span style="background:#FFFFFF; color:#3A3F66; font-size:12px; font-weight:700; padding:9px 18px; --sl:6px; --bc:#D2CEEA;" class="bx">70+ Cultural Milestones</span>
        <span style="background:#FFFFFF; color:#3A3F66; font-size:12px; font-weight:700; padding:9px 18px; --sl:6px; --bc:#D2CEEA;" class="bx">10 Core Team Members</span>
        <span style="background:#FFFFFF; color:#3A3F66; font-size:12px; font-weight:700; padding:9px 18px; --sl:6px; --bc:#D2CEEA;" class="bx">143 UK Companies Advised</span>
        <span style="background:#FFFFFF; color:#3A3F66; font-size:12px; font-weight:700; padding:9px 18px; --sl:6px; --bc:#D2CEEA;" class="bx">5 Strategic Pillars</span>
      </div>
  ...
  <section style="padding:60px 20px; background:#F3F1FC;">
    <div style="max-width:1100px; margin:0 auto;">
      <div class="reveal" style="text-align:center; margin-bottom:44px;">
        <span class="eyebrow">Milestones Across The UK</span>
        <h2 class="bebas" style="font-size:42px; margin:12px 0 10px; color:#10142E;">OUR EVENT LEGACY: OVER 70 CULTURAL MILESTONES ACTIVATED</h2>
        <p style="font-size:15.5px; color:#5A5F86; max-width:680px; margin:0 auto; line-height:1.7;">Over the years, we have designed, produced, and executed more than 70 major cultural gatherings and high-profile events across the UK. Our signature productions and cultural milestones include:</p>
      </div>
      ...
      <div style="display:grid; grid-template-columns:repeat(3, minmax(0, 1fr)); gap:22px;" class="reveal" data-m="g1">
        <div class="bento-tile" style="background:#FFFFFF; border:1.5px solid #E1DEF3; border-radius:18px; padding:28px 26px;">
          ...
          <h3 class="bebas" style="font-size:24px; color:#10142E; margin:0 0 10px;">YAGI AWARDS &amp; BLACK AWARD EVENTS</h3>
          <p style="font-size:13.5px; line-height:1.65; color:#5A5F86; margin:0;">Premier celebratory galas honoring outstanding contributions in leadership, culture, entrepreneurship, and community empowerment.</p>
        </div>

        <div class="bento-tile" style="background:#FFFFFF; border:1.5px solid #E1DEF3; border-radius:18px; padding:28px 26px;">
          <span class="bebas" style="font-size:32px; color:#6C58DB; display:block; margin-bottom:8px;">02</span>
          <h3 class="bebas" style="font-size:24px; color:#10142E; margin:0 0 10px;">GANGS OF LAGOS: WEDDING STORY (PARTS 1 &amp; 2)</h3>
          <p style="font-size:13.5px; line-height:1.65; color:#5A5F86; margin:0;">High-production, cinematic theatrical wedding activations that set new benchmarks for immersive cultural storytelling in the UK.</p>
        </div>

        <div class="bento-tile" style="background:#FFFFFF; border:1.5px solid #E1DEF3; border-radius:18px; padding:28px 26px;">
          <span class="bebas" style="font-size:32px; color:#002671; display:block; margin-bottom:8px;">03</span>
          <h3 class="bebas" style="font-size:24px; color:#10142E; margin:0 0 10px;">YAGI TRADE FAIR</h3>
          <p style="font-size:13.5px; line-height:1.65; color:#5A5F86; margin:0;">Multi-sector commercial expo facilitating trade partnerships, live retail sales, and corporate networking for independent diaspora enterprises.</p>
        </div>

        <div class="bento-tile" style="background:#FFFFFF; border:1.5px solid #E1DEF3; border-radius:18px; padding:28px 26px;">
          <span class="bebas" style="font-size:32px; color:#BA0000; display:block; margin-bottom:8px;">04</span>
          <h3 class="bebas" style="font-size:24px; color:#10142E; margin:0 0 10px;">NAIJA FOOD CARNIVAL</h3>
          <p style="font-size:13.5px; line-height:1.65; color:#5A5F86; margin:0;">400+ guests unified in Sheffield for an unforgettable celebration of culinary heritage, live music, and authentic community bonding.</p>
        </div>
        ...
        <div class="bento-tile" style="background:#FFFFFF; border:1.5px solid #E1DEF3; border-radius:18px; padding:28px 26px; grid-column:span 2;" data-m="span">
          ...
          <h3 class="bebas" style="font-size:24px; color:#10142E; margin:0 0 10px;">MARKETPLACE FESTIVALS (VOLUMES 1 THROUGH 6)</h3>
          <p style="font-size:13.5px; line-height:1.65; color:#5A5F86; margin:0;">Six consecutive landmark festival editions providing platforms for over 120 diaspora food vendors, artisans, performers, and thousands of attendees across the North of England.</p>
        </div>
      </div>
    </div>
  </section>
  ...
  <section style="padding:64px 20px; background:#FFFFFF;">
    <div style="max-width:1100px; margin:0 auto;">
      <div class="reveal" style="margin-bottom:44px;">
        <span class="eyebrow" style="color:#6C58DB;">Enterprise Acceleration Since 2024</span>
        <h2 class="bebas" style="font-size:42px; margin:12px 0 14px; color:#10142E;">GLOBAL BUSINESS CONSULTANCY &amp; ENTERPRISE GROWTH</h2>
        <p style="font-size:16px; line-height:1.8; color:#3A3F66; max-width:820px; margin:0;">In 2024, we expanded our footprint into full-scale business consultancy — and since then, we have been the driving force behind numerous commercial success stories. Having worked with <strong>143 registered companies across the UK</strong>, we provide end-to-end guidance from concept to market dominance.</p>
      </div>
      ...
      <div style="display:grid; grid-template-columns:repeat(5, minmax(0, 1fr)); gap:18px; margin-bottom:48px;" class="reveal" data-m="g1">
        <div style="background:#F4F5FA; border:1.5px solid #E1DEF3; border-radius:16px; padding:24px 20px; display:flex; flex-direction:column; justify-content:space-between;">
          <div>
            <span class="bebas" style="font-size:26px; color:#6C58DB;">PILLAR 01</span>
            <h3 style="font-size:15px; font-weight:800; color:#10142E; margin:8px 0 8px;">From Blueprint to Reality</h3>
            <p style="font-size:13px; line-height:1.6; color:#5A5F86; margin:0;">Building comprehensive business plans and actualizing them from scratch.</p>
          </div>
        </div>

        <div style="background:#F4F5FA; border:1.5px solid #E1DEF3; border-radius:16px; padding:24px 20px; display:flex; flex-direction:column; justify-content:space-between;">
          <div>
            <span class="bebas" style="font-size:26px; color:#BA0000;">PILLAR 02</span>
            <h3 style="font-size:15px; font-weight:800; color:#10142E; margin:8px 0 8px;">Infrastructure &amp; Setup</h3>
            <p style="font-size:13px; line-height:1.6; color:#5A5F86; margin:0;">Shop siting, office installation, spatial design, build-up management, and full company structuring.</p>
          </div>
        </div>

        <div style="background:#F4F5FA; border:1.5px solid #E1DEF3; border-radius:16px; padding:24px 20px; display:flex; flex-direction:column; justify-content:space-between;">
          <div>
            <span class="bebas" style="font-size:26px; color:#002671;">PILLAR 03</span>
            <h3 style="font-size:15px; font-weight:800; color:#10142E; margin:8px 0 8px;">Scaling &amp; Advisory</h3>
            <p style="font-size:13px; line-height:1.6; color:#5A5F86; margin:0;">Business sales scaling, strategic growth advising, and sponsorship application support.</p>
          </div>
        </div>

        <div style="background:#F4F5FA; border:1.5px solid #E1DEF3; border-radius:16px; padding:24px 20px; display:flex; flex-direction:column; justify-content:space-between;">
          <div>
            <span class="bebas" style="font-size:26px; color:#6C58DB;">PILLAR 04</span>
            <h3 style="font-size:15px; font-weight:800; color:#10142E; margin:8px 0 8px;">Specialized Visas &amp; Immigration Pathways</h3>
            <p style="font-size:13px; line-height:1.6; color:#5A5F86; margin:0;">Expert advisory on Global Talent and Innovator visas.</p>
          </div>
        </div>

        <div style="background:#F4F5FA; border:1.5px solid #E1DEF3; border-radius:16px; padding:24px 20px; display:flex; flex-direction:column; justify-content:space-between;">
          <div>
            <span class="bebas" style="font-size:26px; color:#BA0000;">PILLAR 05</span>
            <h3 style="font-size:15px; font-weight:800; color:#10142E; margin:8px 0 8px;">Go-to-Market Mastery</h3>
            <p style="font-size:13px; line-height:1.6; color:#5A5F86; margin:0;">Tailored marketing strategies and approaches for diverse business models and regional or international expansion.</p>
          </div>
        </div>
      </div>
      ...
      <div style="background:#111838; border-radius:22px; padding:36px 32px; border:1.5px solid #1E2B5E;" class="reveal">
        <div style="display:flex; justify-content:space-between; align-items:flex-end; margin-bottom:24px; flex-wrap:wrap; gap:16px;">
          <div>
            <span class="eyebrow" style="color:#B7A6FF !important;">Real Commercial Infrastructure Execution</span>
            <h3 class="bebas" style="font-size:32px; color:#FFFFFF; margin:8px 0 0;">FROM EMPTY SHELL TO OPERATIONAL SUCCESS</h3>
          </div>
          <p style="font-size:14px; color:#A3A9C8; max-width:440px; margin:0;">We don't just draft pitch decks — our team sources physical locations, project-manages build-outs, and stocks retail operations.</p>
        </div>
  ...
  <section style="position:relative; min-height:540px; overflow:hidden; display:flex; align-items:center;">
    ...
    <div style="position:relative; z-index:1; width:100%; display:flex; justify-content:space-between; align-items:center; gap:40px; padding:0 64px; flex-wrap:wrap;" class="reveal" data-m="prefooter-inner">
      ...
      <div class="prefooter__badge" style="width:160px; height:160px; flex:0 0 160px;">
        <a href="<?php echo esc_url( home_url( "/contact/?type=consultancy" ) ); ?>" class="prefooter__badge-link" aria-label="Plan An Event" style="display:block; width:100%; height:100%; text-decoration:none; transition:transform .3s ease;">
