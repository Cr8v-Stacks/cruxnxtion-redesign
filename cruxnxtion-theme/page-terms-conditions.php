...
<div style="width:100%; max-width:100%; margin:0; background:#FFFFFF; overflow-x:clip;" data-m="root">
  ...
  <section style=" padding:44px 20px 30px 20px; background:#F3F1FC; border-bottom:1px solid #E1DEF3;">
    ...
    <h1 class="bebas" style="font-size:44px; margin:14px 0px 14px 0px; color:#10142E;">TERMS &amp; CONDITIONS</h1>
    <p style="font-size:15px; line-height:1.65; color:#5A5F86; max-width:640px; margin:0px 0px 6px 0px;" class="reveal">The ground rules for using our website and booking our services.</p>
  ...
  <section style=" padding:56px 20px 44px 20px; display:grid; grid-template-columns:280px 1fr; gap:64px; align-items:start;" data-m="g1">
    <div style="position:sticky; top:24px;" class="reveal" data-m="static"><div style="font-size:11px; letter-spacing:2.6px; font-weight:700; color:#6C58DB; margin-bottom:12px;">ON THIS PAGE</div><a href="#s1" style="display:block; font-size:14px; color:#5A5F86; padding:9px 0px 9px 14px; border-left:2px solid #E1DEF3;">1. About these terms</a><a href="#s2" style="display:block; font-size:14px; color:#5A5F86; padding:9px 0px 9px 14px; border-left:2px solid #E1DEF3;">2. Event bookings and services</a><a href="#s3" style="display:block; font-size:14px; color:#5A5F86; padding:9px 0px 9px 14px; border-left:2px solid #E1DEF3;">3. Tickets to our events</a><a href="#s4" style="display:block; font-size:14px; color:#5A5F86; padding:9px 0px 9px 14px; border-left:2px solid #E1DEF3;">4. Photography and filming</a><a href="#s5" style="display:block; font-size:14px; color:#5A5F86; padding:9px 0px 9px 14px; border-left:2px solid #E1DEF3;">5. Our content</a><a href="#s6" style="display:block; font-size:14px; color:#5A5F86; padding:9px 0px 9px 14px; border-left:2px solid #E1DEF3;">6. Liability</a><a href="#s7" style="display:block; font-size:14px; color:#5A5F86; padding:9px 0px 9px 14px; border-left:2px solid #E1DEF3;">7. Governing law</a><a href="#s8" style="display:block; font-size:14px; color:#5A5F86; padding:9px 0px 9px 14px; border-left:2px solid #E1DEF3;">8. Contact</a>
    ...
    <div style="max-width:760px;" class="reveal">
      <div id="s1" style="margin-bottom:40px;"><h2 class="bebas" style="font-size:38px; margin:0px 0px 12px 0px; color:#10142E;">1. About these terms</h2><p style="font-size:15px; line-height:1.75; color:#3A3F66; margin:0px 0px 12px 0px;">These terms apply to your use of this website and to any enquiry you make with Crux Nxtion Events (29 Dun Work, Sheffield S3 8FB, United Kingdom). By using the site you agree to them.</p></div>
      <div id="s2" style="margin-bottom:40px;"><h2 class="bebas" style="font-size:38px; margin:0px 0px 12px 0px; color:#10142E;">2. Event bookings and services</h2><p style="font-size:15px; line-height:1.75; color:#3A3F66; margin:0px 0px 12px 0px;">A booking or consultancy engagement is only confirmed once we have agreed the scope, price and date in writing and any deposit has been received.</p><p style="font-size:15px; line-height:1.75; color:#3A3F66; margin:0px 0px 12px 0px;">Each booking is covered by a written proposal or agreement that sets out deposits, payment dates, changes and cancellation. Where that document differs from these terms, the document applies.</p></div>
      <div id="s3" style="margin-bottom:40px;"><h2 class="bebas" style="font-size:38px; margin:0px 0px 12px 0px; color:#10142E;">3. Tickets to our events</h2><p style="font-size:15px; line-height:1.75; color:#3A3F66; margin:0px 0px 12px 0px;">Tickets are sold through third-party platforms and are subject to their terms as well as any event-specific conditions on the ticket page. Age limits and venue rules apply and entry may be refused where they are not met.</p></div>
      <div id="s4" style="margin-bottom:40px;"><h2 class="bebas" style="font-size:38px; margin:0px 0px 12px 0px; color:#10142E;">4. Photography and filming</h2><p style="font-size:15px; line-height:1.75; color:#3A3F66; margin:0px 0px 12px 0px;">We photograph and film at our events for marketing and to share memories. Notices will be displayed at the venue. If you would rather not appear, please tell a member of the crew.</p></div>
      <div id="s5" style="margin-bottom:40px;"><h2 class="bebas" style="font-size:38px; margin:0px 0px 12px 0px; color:#10142E;">5. Our content</h2><p style="font-size:15px; line-height:1.75; color:#3A3F66; margin:0px 0px 12px 0px;">All text, images, logos and designs on this website belong to Crux Nxtion Events or its licensors. You may not copy or reuse them without written permission.</p></div>
      <div id="s6" style="margin-bottom:40px;"><h2 class="bebas" style="font-size:38px; margin:0px 0px 12px 0px; color:#10142E;">6. Liability</h2><p style="font-size:15px; line-height:1.75; color:#3A3F66; margin:0px 0px 12px 0px;">We take care to keep the website accurate but provide it as is. Nothing in these terms limits liability that cannot lawfully be limited, including for death or personal injury caused by negligence or for fraud.</p></div>
      <div id="s7" style="margin-bottom:40px;"><h2 class="bebas" style="font-size:38px; margin:0px 0px 12px 0px; color:#10142E;">7. Governing law</h2><p style="font-size:15px; line-height:1.75; color:#3A3F66; margin:0px 0px 12px 0px;">These terms are governed by the laws of England and Wales and disputes are subject to the courts of England and Wales.</p></div>
      <div id="s8" style="margin-bottom:40px;"><h2 class="bebas" style="font-size:38px; margin:0px 0px 12px 0px; color:#10142E;">8. Contact</h2><p style="font-size:15px; line-height:1.75; color:#3A3F66; margin:0px 0px 12px 0px;">Email <a href="<?php echo esc_url( 'mailto:' . antispambot( 'infoandsales@cruxnxtion.co.uk' ) ); ?>" style="color:#002671; font-weight:600; text-decoration:underline;"><?php echo esc_html( antispambot( 'infoandsales@cruxnxtion.co.uk' ) ); ?></a> with any questions about these terms.</p></div>
    </div>
  </section>
